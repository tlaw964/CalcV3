...
class siteGUI:  # (U)ser input or (R)eport or both?        Description
    ...
    GUI_process_option = str(
        'basicdata')  # U   Contents is one of.... 'basicdata' 'pipe' 'pipeeff' 'pendiaLk' 'pendia' 'SetLkNumLHandJ' 'SetNumLHandJ' 'SetCableEff'  'NewCable' 'NewCableV' 'NewCableMaterial' 'NewCablesize' 'NewCableAWG'  'NewCablesize' 'CableLock'
    ...
    GUI_LHtype = str(
        'LH/LH Pro')  # U   'LH1500 and Pro', 'LH1500 Pro +', 'LH1500 and Pro with SD PCB', 'LH1500 Pro + with SD PCB'
    ...
    GUI_pipe_mat = str(
        '')  # U   Either 'Drawn plastic tube','General steel','Asphalted iron','Galv. steel','Cast steel','Wood','Concrete','RivetedSteel'
    ...
    GUI_LH_head = str(
        '')  # UR  This is the actual head at the LH turbine. It is from flume top to river exit. It is the head the LH experiences.
    ...
    GUI_LH_rpm_NL = str(
        '')  # R   Generator rpm at actual head with max. possible water throughput and no electrical load
    ...
    GUI_LH_V_NL = str(
        '')  # R   Generator output voltage at actual head with max. possible water throughput and no electrical load
    ...
    GUI_Load_Vmax = str(
        '')  # UR  a united int string eg '56 V'   This is the maximum voltage the inverter/charge controller can handle.
    GUI_Load_Vmin = str(
        '')  # UR  a united int string eg '56 V'   This is the maimium working for the inverter/charge controller.
...
class site:
    ...
    magic7 = {'60R85-12S1P-S': 0.5, '60R110-12S1P-D': 0.5, '60R100-12S1P-D': 0.5, '60R85-12S1P-D': 0.5,
              '60R85-6S2P-S': 0.5, '60R110-4S3P-S': 0.5, '60R110-6S2P-D': 1, \
              '60R100-3S4P-S': 0.6, '60R90-3S4P-S': 0.6, '60R100-4S3P-D': 0.6, '60R100-2S6P-S': 0.6,
              '60R90-3S4P-D': 0.6, '60R90-2S6P-S': 0.6}
    ...
    convert = {'ft-m': 3.28083989501312, 'in-m': 39.3700787401575, 'gpm-lps': 15.8704967465482, 'awg- awg': 1, \
               'm-ft': 0.3048, 'm-in': 0.0254, 'm-cm': 0.01, 'm-m': 1, 'm-mm': 0.001, 'm-mile': 1609.344,
               'm-kpa': 0.102, 'm-LHi': 0.703, 'm-bar': 10.197, 'm-atm': 10.33211, \
               'mm-ft': 304.8, 'mm-in': 25.4, 'mm-cm': 10, 'mm-m': 1000, 'mm-mm': 1, 'mm-mile': 1609344, 'mm-kpa': 102,
               'mm-LHi': 703, 'mm-bar': 10197, 'mm-atm': 10332.11, \
               'lps-lps': 1, 'lps-lpm': 60, 'lps-lph': 3600, 'lps-gpm': 0.06301, 'lps-cfs': 28.316846592,
               'lps-cfm': 0.4719474432, 'lps-cfh': 0.00786579072, 'lps-cfd': 0.00032774128, 'lps-cumecs': 1000, \
    ...
    LHdata.update(
        {'1_1.0m_l/s': 25, '1_1.0m_Watts': 91, '1_1.0m_Efficiency': 38, '1_1.0m_RPM': 688, '1_1.0m_R.RPM': 1032,
         '1_1.0m_W.RPM': 0, '1_1.0m_DT': 0.19, '1_1.0m_DT W': 9, '1_1.0m_A.Stator': '100-7s-2p- star',
         '1_1.0m_A.OC V': 137, '1_1.0m_A.R V': 69, '1_1.0m_B.Stator': '80-7s-2p-delta', '1_1.0m_B.OC V': 205,
         '1_1.0m_B.R V': 103, '1_1.0m_C.Stator': '80-7s-2p-star', '1_1.0m_C.OC V': 361, '1_1.0m_C.R V': 181,
         '1_1.0m_D.Stator': '80-14s-1p-delta', '1_1.0m_D.OC V': 411, '1_1.0m_D.R V': 205, })
    LHdata.update(
        {'1_1.1m_l/s': 26, '1_1.1m_Watts': 107, '1_1.1m_Efficiency': 38, '1_1.1m_RPM': 722, '1_1.1m_R.RPM': 1083,
         '1_1.1m_W.RPM': 0, '1_1.1m_DT': 0.19, '1_1.1m_DT W': 11, '1_1.1m_A.Stator': '100-7s-2p- star',
         '1_1.1m_A.OC V': 144, '1_1.1m_A.R V': 72, '1_1.1m_B.Stator': '80-7s-2p-delta', '1_1.1m_B.OC V': 215,
         '1_1.1m_B.R V': 108, '1_1.1m_C.Stator': '80-7s-2p-star', '1_1.1m_C.OC V': 379, '1_1.1m_C.R V': 189,
         '1_1.1m_D.Stator': '80-14s-1p-delta', '1_1.1m_D.OC V': 431, '1_1.1m_D.R V': 215, })
    LHdata.update(
        {'1_1.2m_l/s': 27, '1_1.2m_Watts': 123, '1_1.2m_Efficiency': 39, '1_1.2m_RPM': 754, '1_1.2m_R.RPM': 1131,
         '1_1.2m_W.RPM': 0, '1_1.2m_DT': 0.19, '1_1.2m_DT W': 12, '1_1.2m_A.Stator': '100-7s-2p- star',
         '1_1.2m_A.OC V': 150, '1_1.2m_A.R V': 75, '1_1.2m_B.Stator': '80-7s-2p-delta', '1_1.2m_B.OC V': 225,
         '1_1.2m_B.R V': 113, '1_1.2m_C.Stator': '80-7s-2p-star', '1_1.2m_C.OC V': 396, '1_1.2m_C.R V': 198,
         '1_1.2m_D.Stator': '80-14s-1p-delta', '1_1.2m_D.OC V': 450, '1_1.2m_D.R V': 225, })
    LHdata.update(
        {'1_1.3m_l/s': 28, '1_1.3m_Watts': 176, '1_1.3m_Efficiency': 49, '1_1.3m_RPM': 785, '1_1.3m_R.RPM': 1177,
         '1_1.3m_W.RPM': 0, '1_1.3m_DT': 0.19, '1_1.3m_DT W': 14, '1_1.3m_A.Stator': '80-2s-7p-star',
         '1_1.3m_A.OC V': 118, '1_1.3m_A.R V': 59, '1_1.3m_B.Stator': '80-7s-2p-delta', '1_1.3m_B.OC V': 234,
         '1_1.3m_B.R V': 117, '1_1.3m_C.Stator': '100-14s-1p-star', '1_1.3m_C.OC V': 313, '1_1.3m_C.R V': 157,
         '1_1.3m_D.Stator': '80-14s-1p-delta', '1_1.3m_D.OC V': 468, '1_1.3m_D.R V': 234, })
    LHdata.update(
        {'1_1.4m_l/s': 29, '1_1.4m_Watts': 199, '1_1.4m_Efficiency': 50, '1_1.4m_RPM': 814, '1_1.4m_R.RPM': 1221,
         '1_1.4m_W.RPM': 0, '1_1.4m_DT': 0.19, '1_1.4m_DT W': 16, '1_1.4m_A.Stator': '80-2s-7p-star',
         '1_1.4m_A.OC V': 122, '1_1.4m_A.R V': 61, '1_1.4m_B.Stator': '80-7s-2p-delta', '1_1.4m_B.OC V': 243,
         '1_1.4m_B.R V': 122, '1_1.4m_C.Stator': '100-14s-1p-star', '1_1.4m_C.OC V': 325, '1_1.4m_C.R V': 162,
         '1_1.4m_D.Stator': '80-14s-1p-delta', '1_1.4m_D.OC V': 486, '1_1.4m_D.R V': 243, })
    LHdata.update(
        {'1_1.5m_l/s': 30, '1_1.5m_Watts': 223, '1_1.5m_Efficiency': 50, '1_1.5m_RPM': 843, '1_1.5m_R.RPM': 1264,
         '1_1.5m_W.RPM': 0, '1_1.5m_DT': 0.19, '1_1.5m_DT W': 17, '1_1.5m_A.Stator': '80-2s-7p-star',
         '1_1.5m_A.OC V': 126, '1_1.5m_A.R V': 63, '1_1.5m_B.Stator': '100-14s-1p-delta', '1_1.5m_B.OC V': 192,
         '1_1.5m_B.R V': 96, '1_1.5m_C.Stator': '100-14s-1p-star', '1_1.5m_C.OC V': 336, '1_1.5m_C.R V': 168,
         '1_1.5m_D.Stator': '80-7s-2p-star', '1_1.5m_D.OC V': 442, '1_1.5m_D.R V': 221, })
    LHdata.update(
        {'1_1.6m_l/s': 31, '1_1.6m_Watts': 248, '1_1.6m_Efficiency': 50, '1_1.6m_RPM': 870, '1_1.6m_R.RPM': 1306,
         '1_1.6m_W.RPM': 0, '1_1.6m_DT': 0.19, '1_1.6m_DT W': 19, '1_1.6m_A.Stator': '80-2s-7p-star',
         '1_1.6m_A.OC V': 130, '1_1.6m_A.R V': 65, '1_1.6m_B.Stator': '100-14s-1p-delta', '1_1.6m_B.OC V': 198,
         '1_1.6m_B.R V': 99, '1_1.6m_C.Stator': '100-14s-1p-star', '1_1.6m_C.OC V': 347, '1_1.6m_C.R V': 174,
         '1_1.6m_D.Stator': '80-7s-2p-star', '1_1.6m_D.OC V': 457, '1_1.6m_D.R V': 228, })
    LHdata.update(
        {'1_1.7m_l/s': 32, '1_1.7m_Watts': 272, '1_1.7m_Efficiency': 51, '1_1.7m_RPM': 897, '1_1.7m_R.RPM': 1346,
         '1_1.7m_W.RPM': 0, '1_1.7m_DT': 0.19, '1_1.7m_DT W': 21, '1_1.7m_A.Stator': '80-2s-7p-star',
         '1_1.7m_A.OC V': 134, '1_1.7m_A.R V': 67, '1_1.7m_B.Stator': '100-14s-1p-delta', '1_1.7m_B.OC V': 205,
         '1_1.7m_B.R V': 102, '1_1.7m_C.Stator': '100-14s-1p-star', '1_1.7m_C.OC V': 358, '1_1.7m_C.R V': 179,
         '1_1.7m_D.Stator': '80-7s-2p-star', '1_1.7m_D.OC V': 471, '1_1.7m_D.R V': 236, })
    LHdata.update(
        {'1_1.8m_l/s': 33, '1_1.8m_Watts': 297, '1_1.8m_Efficiency': 51, '1_1.8m_RPM': 923, '1_1.8m_R.RPM': 1385,
         '1_1.8m_W.RPM': 0, '1_1.8m_DT': 0.19, '1_1.8m_DT W': 23, '1_1.8m_A.Stator': '80-2s-7p-star',
         '1_1.8m_A.OC V': 138, '1_1.8m_A.R V': 69, '1_1.8m_B.Stator': '100-14s-1p-delta', '1_1.8m_B.OC V': 211,
         '1_1.8m_B.R V': 105, '1_1.8m_C.Stator': '100-14s-1p-star', '1_1.8m_C.OC V': 368, '1_1.8m_C.R V': 184,
         '1_1.8m_D.Stator': '80-7s-2p-star', '1_1.8m_D.OC V': 485, '1_1.8m_D.R V': 242, })
    LHdata.update(
        {'1_1.9m_l/s': 34, '1_1.9m_Watts': 323, '1_1.9m_Efficiency': 51, '1_1.9m_RPM': 949, '1_1.9m_R.RPM': 1423,
         '1_1.9m_W.RPM': 0, '1_1.9m_DT': 0.19, '1_1.9m_DT W': 25, '1_1.9m_A.Stator': '80-2s-7p-star',
         '1_1.9m_A.OC V': 142, '1_1.9m_A.R V': 71, '1_1.9m_B.Stator': '100-14s-1p-delta', '1_1.9m_B.OC V': 216,
         '1_1.9m_B.R V': 108, '1_1.9m_C.Stator': '100-14s-1p-star', '1_1.9m_C.OC V': 378, '1_1.9m_C.R V': 189,
         '1_1.9m_D.Stator': '60-7s-2p-delta', '1_1.9m_D.OC V': 413, '1_1.9m_D.R V': 206, })
    LHdata.update(
        {'1_2.0m_l/s': 35, '1_2.0m_Watts': 349, '1_2.0m_Efficiency': 51, '1_2.0m_RPM': 973, '1_2.0m_R.RPM': 1460,
         '1_2.0m_W.RPM': 0, '1_2.0m_DT': 0.19, '1_2.0m_DT W': 27, '1_2.0m_A.Stator': '80-2s-7p-star',
         '1_2.0m_A.OC V': 146, '1_2.0m_A.R V': 73, '1_2.0m_B.Stator': '100-14s-1p-delta', '1_2.0m_B.OC V': 222,
         '1_2.0m_B.R V': 111, '1_2.0m_C.Stator': '100-14s-1p-star', '1_2.0m_C.OC V': 388, '1_2.0m_C.R V': 194,
         '1_2.0m_D.Stator': '60-7s-2p-delta', '1_2.0m_D.OC V': 423, '1_2.0m_D.R V': 212, })
    LHdata.update(
        {'1_2.1m_l/s': 36, '1_2.1m_Watts': 376, '1_2.1m_Efficiency': 51, '1_2.1m_RPM': 997, '1_2.1m_R.RPM': 1496,
         '1_2.1m_W.RPM': 0, '1_2.1m_DT': 0.19, '1_2.1m_DT W': 29, '1_2.1m_A.Stator': '80-2s-7p-star',
         '1_2.1m_A.OC V': 149, '1_2.1m_A.R V': 75, '1_2.1m_B.Stator': '100-14s-1p-delta', '1_2.1m_B.OC V': 227,
         '1_2.1m_B.R V': 114, '1_2.1m_C.Stator': '100-14s-1p-star', '1_2.1m_C.OC V': 398, '1_2.1m_C.R V': 199,
         '1_2.1m_D.Stator': '60-7s-2p-delta', '1_2.1m_D.OC V': 434, '1_2.1m_D.R V': 217, })
    LHdata.update(
        {'1_2.2m_l/s': 37, '1_2.2m_Watts': 404, '1_2.2m_Efficiency': 51, '1_2.2m_RPM': 1021, '1_2.2m_R.RPM': 1531,
         '1_2.2m_W.RPM': 0, '1_2.2m_DT': 0.19, '1_2.2m_DT W': 31, '1_2.2m_A.Stator': '80-2s-7p-star',
         '1_2.2m_A.OC V': 153, '1_2.2m_A.R V': 76, '1_2.2m_B.Stator': '100-14s-1p-delta', '1_2.2m_B.OC V': 233,
         '1_2.2m_B.R V': 116, '1_2.2m_C.Stator': '80-7s-2p-delta', '1_2.2m_C.OC V': 305, '1_2.2m_C.R V': 152,
         '1_2.2m_D.Stator': '60-7s-2p-delta', '1_2.2m_D.OC V': 444, '1_2.2m_D.R V': 222, })
    LHdata.update(
        {'1_2.3m_l/s': 38, '1_2.3m_Watts': 433, '1_2.3m_Efficiency': 51, '1_2.3m_RPM': 1044, '1_2.3m_R.RPM': 1565,
         '1_2.3m_W.RPM': 0, '1_2.3m_DT': 0.19, '1_2.3m_DT W': 33, '1_2.3m_A.Stator': '100-7s-2p-delta',
         '1_2.3m_A.OC V': 119, '1_2.3m_A.R V': 59, '1_2.3m_B.Stator': '100-14s-1p-delta', '1_2.3m_B.OC V': 238,
         '1_2.3m_B.R V': 119, '1_2.3m_C.Stator': '80-7s-2p-delta', '1_2.3m_C.OC V': 312, '1_2.3m_C.R V': 156,
         '1_2.3m_D.Stator': '60-7s-2p-delta', '1_2.3m_D.OC V': 454, '1_2.3m_D.R V': 227, })
    LHdata.update(
        {'1_2.4m_l/s': 38, '1_2.4m_Watts': 463, '1_2.4m_Efficiency': 51, '1_2.4m_RPM': 1066, '1_2.4m_R.RPM': 1599,
         '1_2.4m_W.RPM': 0, '1_2.4m_DT': 0.19, '1_2.4m_DT W': 35, '1_2.4m_A.Stator': '100-7s-2p-delta',
         '1_2.4m_A.OC V': 122, '1_2.4m_A.R V': 61, '1_2.4m_B.Stator': '100-14s-1p-delta', '1_2.4m_B.OC V': 243,
         '1_2.4m_B.R V': 122, '1_2.4m_C.Stator': '80-7s-2p-delta', '1_2.4m_C.OC V': 318, '1_2.4m_C.R V': 159,
         '1_2.4m_D.Stator': '60-7s-2p-delta', '1_2.4m_D.OC V': 464, '1_2.4m_D.R V': 232, })
    LHdata.update(
        {'1_2.5m_l/s': 39, '1_2.5m_Watts': 493, '1_2.5m_Efficiency': 51, '1_2.5m_RPM': 1088, '1_2.5m_R.RPM': 1632,
         '1_2.5m_W.RPM': 0, '1_2.5m_DT': 0.19, '1_2.5m_DT W': 37, '1_2.5m_A.Stator': '100-7s-2p-delta',
         '1_2.5m_A.OC V': 124, '1_2.5m_A.R V': 62, '1_2.5m_B.Stator': '100-7s-2p-star', '1_2.5m_B.OC V': 217,
         '1_2.5m_B.R V': 109, '1_2.5m_C.Stator': '80-7s-2p-delta', '1_2.5m_C.OC V': 325, '1_2.5m_C.R V': 162,
         '1_2.5m_D.Stator': '60-7s-2p-delta', '1_2.5m_D.OC V': 473, '1_2.5m_D.R V': 237, })
    LHdata.update(
        {'1_2.6m_l/s': 40, '1_2.6m_Watts': 524, '1_2.6m_Efficiency': 51, '1_2.6m_RPM': 1110, '1_2.6m_R.RPM': 1664,
         '1_2.6m_W.RPM': 0, '1_2.6m_DT': 0.19, '1_2.6m_DT W': 40, '1_2.6m_A.Stator': '100-7s-2p-delta',
         '1_2.6m_A.OC V': 126, '1_2.6m_A.R V': 63, '1_2.6m_B.Stator': '100-7s-2p-star', '1_2.6m_B.OC V': 221,
         '1_2.6m_B.R V': 111, '1_2.6m_C.Stator': '80-7s-2p-delta', '1_2.6m_C.OC V': 331, '1_2.6m_C.R V': 166,
         '1_2.6m_D.Stator': '60-7s-2p-delta', '1_2.6m_D.OC V': 483, '1_2.6m_D.R V': 241, })
    LHdata.update(
        {'1_2.7m_l/s': 41, '1_2.7m_Watts': 555, '1_2.7m_Efficiency': 52, '1_2.7m_RPM': 1131, '1_2.7m_R.RPM': 1696,
         '1_2.7m_W.RPM': 0, '1_2.7m_DT': 0.24, '1_2.7m_DT W': 16, '1_2.7m_A.Stator': '100-7s-2p-delta',
         '1_2.7m_A.OC V': 129, '1_2.7m_A.R V': 64, '1_2.7m_B.Stator': '100-7s-2p-star', '1_2.7m_B.OC V': 226,
         '1_2.7m_B.R V': 113, '1_2.7m_C.Stator': '80-7s-2p-delta', '1_2.7m_C.OC V': 338, '1_2.7m_C.R V': 169,
         '1_2.7m_D.Stator': '60-7s-2p-delta', '1_2.7m_D.OC V': 492, '1_2.7m_D.R V': 246, })
    LHdata.update(
        {'1_2.8m_l/s': 41, '1_2.8m_Watts': 587, '1_2.8m_Efficiency': 52, '1_2.8m_RPM': 1151, '1_2.8m_R.RPM': 1727,
         '1_2.8m_W.RPM': 1, '1_2.8m_DT': 0.24, '1_2.8m_DT W': 17, '1_2.8m_A.Stator': '100-7s-2p-delta',
         '1_2.8m_A.OC V': 131, '1_2.8m_A.R V': 66, '1_2.8m_B.Stator': '100-7s-2p-star', '1_2.8m_B.OC V': 230,
         '1_2.8m_B.R V': 115, '1_2.8m_C.Stator': '80-7s-2p-delta', '1_2.8m_C.OC V': 344, '1_2.8m_C.R V': 172,
         '1_2.8m_D.Stator': '80-7s-2p-delta', '1_2.8m_D.OC V': 344, '1_2.8m_D.R V': 172, })
    LHdata.update(
        {'1_2.9m_l/s': 42, '1_2.9m_Watts': 620, '1_2.9m_Efficiency': 52, '1_2.9m_RPM': 1172, '1_2.9m_R.RPM': 1758,
         '1_2.9m_W.RPM': 1, '1_2.9m_DT': 0.24, '1_2.9m_DT W': 18, '1_2.9m_A.Stator': '100-7s-2p-delta',
         '1_2.9m_A.OC V': 134, '1_2.9m_A.R V': 67, '1_2.9m_B.Stator': '100-7s-2p-star', '1_2.9m_B.OC V': 234,
         '1_2.9m_B.R V': 117, '1_2.9m_C.Stator': '80-7s-2p-delta', '1_2.9m_C.OC V': 350, '1_2.9m_C.R V': 175,
         '1_2.9m_D.Stator': '80-7s-2p-delta', '1_2.9m_D.OC V': 350, '1_2.9m_D.R V': 175, })
    LHdata.update(
        {'1_3.0m_l/s': 43, '1_3.0m_Watts': 654, '1_3.0m_Efficiency': 52, '1_3.0m_RPM': 1192, '1_3.0m_R.RPM': 1788,
         '1_3.0m_W.RPM': 1, '1_3.0m_DT': 0.24, '1_3.0m_DT W': 19, '1_3.0m_A.Stator': '100-7s-2p-delta',
         '1_3.0m_A.OC V': 136, '1_3.0m_A.R V': 68, '1_3.0m_B.Stator': '100-7s-2p-star', '1_3.0m_B.OC V': 238,
         '1_3.0m_B.R V': 119, '1_3.0m_C.Stator': '80-7s-2p-delta', '1_3.0m_C.OC V': 356, '1_3.0m_C.R V': 178,
         '1_3.0m_D.Stator': '80-7s-2p-delta', '1_3.0m_D.OC V': 356, '1_3.0m_D.R V': 178, })
    LHdata.update(
        {'1_3.1m_l/s': 44, '1_3.1m_Watts': 688, '1_3.1m_Efficiency': 52, '1_3.1m_RPM': 1212, '1_3.1m_R.RPM': 1817,
         '1_3.1m_W.RPM': 1, '1_3.1m_DT': 0.24, '1_3.1m_DT W': 20, '1_3.1m_A.Stator': '100-7s-2p-delta',
         '1_3.1m_A.OC V': 138, '1_3.1m_A.R V': 69, '1_3.1m_B.Stator': '100-7s-2p-star', '1_3.1m_B.OC V': 242,
         '1_3.1m_B.R V': 121, '1_3.1m_C.Stator': '80-7s-2p-delta', '1_3.1m_C.OC V': 362, '1_3.1m_C.R V': 181,
         '1_3.1m_D.Stator': '80-7s-2p-delta', '1_3.1m_D.OC V': 362, '1_3.1m_D.R V': 181, })
    LHdata.update(
        {'1_3.2m_l/s': 44, '1_3.2m_Watts': 723, '1_3.2m_Efficiency': 52, '1_3.2m_RPM': 1231, '1_3.2m_R.RPM': 1846,
         '1_3.2m_W.RPM': 1, '1_3.2m_DT': 0.24, '1_3.2m_DT W': 21, '1_3.2m_A.Stator': '100-7s-2p-delta',
         '1_3.2m_A.OC V': 140, '1_3.2m_A.R V': 70, '1_3.2m_B.Stator': '100-7s-2p-star', '1_3.2m_B.OC V': 246,
         '1_3.2m_B.R V': 123, '1_3.2m_C.Stator': '80-7s-2p-delta', '1_3.2m_C.OC V': 367, '1_3.2m_C.R V': 184,
         '1_3.2m_D.Stator': '80-7s-2p-delta', '1_3.2m_D.OC V': 367, '1_3.2m_D.R V': 184, })
    LHdata.update(
        {'1_3.3m_l/s': 45, '1_3.3m_Watts': 759, '1_3.3m_Efficiency': 52, '1_3.3m_RPM': 1250, '1_3.3m_R.RPM': 1875,
         '1_3.3m_W.RPM': 1, '1_3.3m_DT': 0.24, '1_3.3m_DT W': 22, '1_3.3m_A.Stator': '100-7s-2p-delta',
         '1_3.3m_A.OC V': 143, '1_3.3m_A.R V': 71, '1_3.3m_B.Stator': '80-2s-7p-star', '1_3.3m_B.OC V': 187,
         '1_3.3m_B.R V': 94, '1_3.3m_C.Stator': '80-7s-2p-delta', '1_3.3m_C.OC V': 373, '1_3.3m_C.R V': 187,
         '1_3.3m_D.Stator': '80-7s-2p-delta', '1_3.3m_D.OC V': 373, '1_3.3m_D.R V': 187, })
    LHdata.update(
        {'1_3.4m_l/s': 46, '1_3.4m_Watts': 795, '1_3.4m_Efficiency': 52, '1_3.4m_RPM': 1269, '1_3.4m_R.RPM': 1903,
         '1_3.4m_W.RPM': 1, '1_3.4m_DT': 0.24, '1_3.4m_DT W': 23, '1_3.4m_A.Stator': '100-7s-2p-delta',
         '1_3.4m_A.OC V': 145, '1_3.4m_A.R V': 72, '1_3.4m_B.Stator': '80-2s-7p-star', '1_3.4m_B.OC V': 190,
         '1_3.4m_B.R V': 95, '1_3.4m_C.Stator': '80-7s-2p-delta', '1_3.4m_C.OC V': 379, '1_3.4m_C.R V': 189,
         '1_3.4m_D.Stator': '80-7s-2p-delta', '1_3.4m_D.OC V': 379, '1_3.4m_D.R V': 189, })
    LHdata.update(
        {'1_3.5m_l/s': 46, '1_3.5m_Watts': 832, '1_3.5m_Efficiency': 52, '1_3.5m_RPM': 1287, '1_3.5m_R.RPM': 1931,
         '1_3.5m_W.RPM': 1, '1_3.5m_DT': 0.24, '1_3.5m_DT W': 24, '1_3.5m_A.Stator': '100-7s-2p-delta',
         '1_3.5m_A.OC V': 147, '1_3.5m_A.R V': 73, '1_3.5m_B.Stator': '80-2s-7p-star', '1_3.5m_B.OC V': 193,
         '1_3.5m_B.R V': 96, '1_3.5m_C.Stator': '80-7s-2p-delta', '1_3.5m_C.OC V': 384, '1_3.5m_C.R V': 192,
         '1_3.5m_D.Stator': '80-7s-2p-delta', '1_3.5m_D.OC V': 384, '1_3.5m_D.R V': 192, })
    LHdata.update(
        {'1_3.6m_l/s': 47, '1_3.6m_Watts': 870, '1_3.6m_Efficiency': 52, '1_3.6m_RPM': 1306, '1_3.6m_R.RPM': 1959,
         '1_3.6m_W.RPM': 1, '1_3.6m_DT': 0.24, '1_3.6m_DT W': 25, '1_3.6m_A.Stator': '100-7s-2p-delta',
         '1_3.6m_A.OC V': 149, '1_3.6m_A.R V': 74, '1_3.6m_B.Stator': '80-2s-7p-star', '1_3.6m_B.OC V': 196,
         '1_3.6m_B.R V': 98, '1_3.6m_C.Stator': '80-7s-2p-delta', '1_3.6m_C.OC V': 390, '1_3.6m_C.R V': 195,
         '1_3.6m_D.Stator': '80-7s-2p-delta', '1_3.6m_D.OC V': 390, '1_3.6m_D.R V': 195, })
    LHdata.update(
        {'1_3.7m_l/s': 48, '1_3.7m_Watts': 908, '1_3.7m_Efficiency': 53, '1_3.7m_RPM': 1324, '1_3.7m_R.RPM': 1986,
         '1_3.7m_W.RPM': 1, '1_3.7m_DT': 0.24, '1_3.7m_DT W': 26,
         '1_3.7m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_3.7m_A.OC V': 0, '1_3.7m_A.R V': 0,
         '1_3.7m_B.Stator': '60dcHP-1s-12p-star', '1_3.7m_B.OC V': 185, '1_3.7m_B.R V': 92,
         '1_3.7m_C.Stator': '60dc-2s-6p-S-HP', '1_3.7m_C.OC V': 371, '1_3.7m_C.R V': 186,
         '1_3.7m_D.Stator': '60dcHP-2s-6p-star', '1_3.7m_D.OC V': 371, '1_3.7m_D.R V': 186, })
    LHdata.update(
        {'1_3.8m_l/s': 48, '1_3.8m_Watts': 947, '1_3.8m_Efficiency': 53, '1_3.8m_RPM': 1341, '1_3.8m_R.RPM': 2012,
         '1_3.8m_W.RPM': 1, '1_3.8m_DT': 0.24, '1_3.8m_DT W': 28,
         '1_3.8m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_3.8m_A.OC V': 0, '1_3.8m_A.R V': 0,
         '1_3.8m_B.Stator': '60dcHP-1s-12p-star', '1_3.8m_B.OC V': 187, '1_3.8m_B.R V': 94,
         '1_3.8m_C.Stator': '60dc-2s-6p-S-HP', '1_3.8m_C.OC V': 376, '1_3.8m_C.R V': 188,
         '1_3.8m_D.Stator': '60dcHP-2s-6p-star', '1_3.8m_D.OC V': 376, '1_3.8m_D.R V': 188, })
    LHdata.update(
        {'1_3.9m_l/s': 49, '1_3.9m_Watts': 986, '1_3.9m_Efficiency': 53, '1_3.9m_RPM': 1359, '1_3.9m_R.RPM': 2038,
         '1_3.9m_W.RPM': 1, '1_3.9m_DT': 0.24, '1_3.9m_DT W': 29,
         '1_3.9m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_3.9m_A.OC V': 0, '1_3.9m_A.R V': 0,
         '1_3.9m_B.Stator': '60dcHP-1s-12p-star', '1_3.9m_B.OC V': 190, '1_3.9m_B.R V': 95,
         '1_3.9m_C.Stator': '60dcHP-2s-6p-star', '1_3.9m_C.OC V': 381, '1_3.9m_C.R V': 191,
         '1_3.9m_D.Stator': '60dcHP-2s-6p-star', '1_3.9m_D.OC V': 381, '1_3.9m_D.R V': 191, })
    LHdata.update(
        {'1_4.0m_l/s': 50, '1_4.0m_Watts': 1026, '1_4.0m_Efficiency': 53, '1_4.0m_RPM': 1376, '1_4.0m_R.RPM': 2064,
         '1_4.0m_W.RPM': 1, '1_4.0m_DT': 0.24, '1_4.0m_DT W': 30,
         '1_4.0m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.0m_A.OC V': 0, '1_4.0m_A.R V': 0,
         '1_4.0m_B.Stator': '60dcHP-1s-12p-star', '1_4.0m_B.OC V': 192, '1_4.0m_B.R V': 96,
         '1_4.0m_C.Stator': '60dcHP-2s-6p-star', '1_4.0m_C.OC V': 386, '1_4.0m_C.R V': 193,
         '1_4.0m_D.Stator': '60dcHP-2s-6p-star', '1_4.0m_D.OC V': 386, '1_4.0m_D.R V': 193, })
    LHdata.update(
        {'1_4.1m_l/s': 50, '1_4.1m_Watts': 1067, '1_4.1m_Efficiency': 53, '1_4.1m_RPM': 1393, '1_4.1m_R.RPM': 2090,
         '1_4.1m_W.RPM': 1, '1_4.1m_DT': 0.24, '1_4.1m_DT W': 31,
         '1_4.1m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.1m_A.OC V': 0, '1_4.1m_A.R V': 0,
         '1_4.1m_B.Stator': '60dcHP-1s-12p-star', '1_4.1m_B.OC V': 194, '1_4.1m_B.R V': 97,
         '1_4.1m_C.Stator': '60dcHP-2s-6p-star', '1_4.1m_C.OC V': 391, '1_4.1m_C.R V': 195,
         '1_4.1m_D.Stator': '60dcHP-2s-6p-star', '1_4.1m_D.OC V': 391, '1_4.1m_D.R V': 195, })
    LHdata.update(
        {'1_4.2m_l/s': 51, '1_4.2m_Watts': 1109, '1_4.2m_Efficiency': 53, '1_4.2m_RPM': 1410, '1_4.2m_R.RPM': 2115,
         '1_4.2m_W.RPM': 1, '1_4.2m_DT': 0.24, '1_4.2m_DT W': 32,
         '1_4.2m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.2m_A.OC V': 0, '1_4.2m_A.R V': 0,
         '1_4.2m_B.Stator': '60dcHP-1s-12p-star', '1_4.2m_B.OC V': 197, '1_4.2m_B.R V': 98,
         '1_4.2m_C.Stator': '60dcHP-2s-6p-star', '1_4.2m_C.OC V': 396, '1_4.2m_C.R V': 198,
         '1_4.2m_D.Stator': '60dcHP-2s-6p-star', '1_4.2m_D.OC V': 396, '1_4.2m_D.R V': 198, })
    LHdata.update(
        {'1_4.3m_l/s': 51, '1_4.3m_Watts': 1151, '1_4.3m_Efficiency': 53, '1_4.3m_RPM': 1427, '1_4.3m_R.RPM': 2140,
         '1_4.3m_W.RPM': 1, '1_4.3m_DT': 0.24, '1_4.3m_DT W': 33,
         '1_4.3m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.3m_A.OC V': 0, '1_4.3m_A.R V': 0,
         '1_4.3m_B.Stator': '60dcHP-1s-12p-star', '1_4.3m_B.OC V': 199, '1_4.3m_B.R V': 100,
         '1_4.3m_C.Stator': '60dcHP-3s-4p-delta', '1_4.3m_C.OC V': 342, '1_4.3m_C.R V': 171,
         '1_4.3m_D.Stator': '60dcHP-2s-6p-star', '1_4.3m_D.OC V': 400, '1_4.3m_D.R V': 200, })
    LHdata.update(
        {'1_4.4m_l/s': 52, '1_4.4m_Watts': 1193, '1_4.4m_Efficiency': 53, '1_4.4m_RPM': 1443, '1_4.4m_R.RPM': 2165,
         '1_4.4m_W.RPM': 1, '1_4.4m_DT': 0.24, '1_4.4m_DT W': 34,
         '1_4.4m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.4m_A.OC V': 0, '1_4.4m_A.R V': 0,
         '1_4.4m_B.Stator': '60dcHP-1s-12p-star', '1_4.4m_B.OC V': 201, '1_4.4m_B.R V': 101,
         '1_4.4m_C.Stator': '60dcHP-3s-4p-delta', '1_4.4m_C.OC V': 346, '1_4.4m_C.R V': 173,
         '1_4.4m_D.Stator': '60dcHP-2s-6p-star', '1_4.4m_D.OC V': 405, '1_4.4m_D.R V': 202, })
    LHdata.update(
        {'1_4.5m_l/s': 53, '1_4.5m_Watts': 1236, '1_4.5m_Efficiency': 53, '1_4.5m_RPM': 1460, '1_4.5m_R.RPM': 2190,
         '1_4.5m_W.RPM': 1, '1_4.5m_DT': 0.24, '1_4.5m_DT W': 35,
         '1_4.5m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.5m_A.OC V': 0, '1_4.5m_A.R V': 0,
         '1_4.5m_B.Stator': '60dcHP-1s-12p-star', '1_4.5m_B.OC V': 204, '1_4.5m_B.R V': 102,
         '1_4.5m_C.Stator': '60dcHP-3s-4p-delta', '1_4.5m_C.OC V': 350, '1_4.5m_C.R V': 175,
         '1_4.5m_D.Stator': '60dcHP-2s-6p-star', '1_4.5m_D.OC V': 409, '1_4.5m_D.R V': 205, })
    LHdata.update(
        {'1_4.6m_l/s': 53, '1_4.6m_Watts': 1280, '1_4.6m_Efficiency': 53, '1_4.6m_RPM': 1476, '1_4.6m_R.RPM': 2214,
         '1_4.6m_W.RPM': 1, '1_4.6m_DT': 0.24, '1_4.6m_DT W': 37,
         '1_4.6m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.6m_A.OC V': 0, '1_4.6m_A.R V': 0,
         '1_4.6m_B.Stator': '60dcHP-1s-12p-star', '1_4.6m_B.OC V': 206, '1_4.6m_B.R V': 103,
         '1_4.6m_C.Stator': '60dcHP-3s-4p-delta', '1_4.6m_C.OC V': 354, '1_4.6m_C.R V': 177,
         '1_4.6m_D.Stator': '60dcHP-2s-6p-star', '1_4.6m_D.OC V': 414, '1_4.6m_D.R V': 207, })
    LHdata.update(
        {'1_4.7m_l/s': 54, '1_4.7m_Watts': 1325, '1_4.7m_Efficiency': 54, '1_4.7m_RPM': 1492, '1_4.7m_R.RPM': 2238,
         '1_4.7m_W.RPM': 1, '1_4.7m_DT': 0.24, '1_4.7m_DT W': 38,
         '1_4.7m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.7m_A.OC V': 0, '1_4.7m_A.R V': 0,
         '1_4.7m_B.Stator': '60dcHP-1s-12p-star', '1_4.7m_B.OC V': 208, '1_4.7m_B.R V': 104,
         '1_4.7m_C.Stator': '60dcHP-3s-4p-delta', '1_4.7m_C.OC V': 358, '1_4.7m_C.R V': 179,
         '1_4.7m_D.Stator': '60dcHP-2s-6p-star', '1_4.7m_D.OC V': 418, '1_4.7m_D.R V': 209, })
    LHdata.update(
        {'1_4.8m_l/s': 54, '1_4.8m_Watts': 1370, '1_4.8m_Efficiency': 54, '1_4.8m_RPM': 1508, '1_4.8m_R.RPM': 2261,
         '1_4.8m_W.RPM': 1, '1_4.8m_DT': 0.24, '1_4.8m_DT W': 39,
         '1_4.8m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.8m_A.OC V': 0, '1_4.8m_A.R V': 0,
         '1_4.8m_B.Stator': '60dcHP-1s-12p-star', '1_4.8m_B.OC V': 210, '1_4.8m_B.R V': 105,
         '1_4.8m_C.Stator': '60dcHP-3s-4p-delta', '1_4.8m_C.OC V': 362, '1_4.8m_C.R V': 181,
         '1_4.8m_D.Stator': '60dcHP-2s-6p-star', '1_4.8m_D.OC V': 423, '1_4.8m_D.R V': 211, })
    LHdata.update(
        {'1_4.9m_l/s': 55, '1_4.9m_Watts': 1415, '1_4.9m_Efficiency': 54, '1_4.9m_RPM': 1523, '1_4.9m_R.RPM': 2285,
         '1_4.9m_W.RPM': 1, '1_4.9m_DT': 0.24, '1_4.9m_DT W': 40,
         '1_4.9m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_4.9m_A.OC V': 0, '1_4.9m_A.R V': 0,
         '1_4.9m_B.Stator': '60dcHP-1s-12p-star', '1_4.9m_B.OC V': 212, '1_4.9m_B.R V': 106,
         '1_4.9m_C.Stator': '60dcHP-3s-4p-delta', '1_4.9m_C.OC V': 366, '1_4.9m_C.R V': 183,
         '1_4.9m_D.Stator': '60dcHP-2s-6p-star', '1_4.9m_D.OC V': 427, '1_4.9m_D.R V': 214, })
    LHdata.update(
        {'1_5.0m_l/s': 55, '1_5.0m_Watts': 1462, '1_5.0m_Efficiency': 54, '1_5.0m_RPM': 1539, '1_5.0m_R.RPM': 2308,
         '1_5.0m_W.RPM': 1, '1_5.0m_DT': 0.24, '1_5.0m_DT W': 42,
         '1_5.0m_A.Stator': ' Not possible. Use 250 vdc regulator', '1_5.0m_A.OC V': 0, '1_5.0m_A.R V': 0,
         '1_5.0m_B.Stator': '60dcHP-1s-12p-star', '1_5.0m_B.OC V': 215, '1_5.0m_B.R V': 107,
         '1_5.0m_C.Stator': '60dcHP-3s-4p-delta', '1_5.0m_C.OC V': 369, '1_5.0m_C.R V': 185,
         '1_5.0m_D.Stator': '60dcHP-2s-6p-star', '1_5.0m_D.OC V': 432, '1_5.0m_D.R V': 216, })

    LHdata.update(
        {'2_1.0m_l/s': 14, '2_1.0m_Watts': 68, '2_1.0m_Efficiency': 49, '2_1.0m_RPM': 1202, '2_1.0m_R.RPM': 2260,
         '2_1.0m_W.RPM': 0, '2_1.0m_DT': 0.15, '2_1.0m_DT W': 5, '2_1.0m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.0m_A.OC V': 54, '2_1.0m_A.R V': 27, '2_1.0m_B.Stator': 'LHM70-3s-2p-D', '2_1.0m_B.OC V': 81,
         '2_1.0m_B.R V': 41, '2_1.0m_C.Stator': 'LHM70-2s-3p-S', '2_1.0m_C.OC V': 99, '2_1.0m_C.R V': 50,
         '2_1.0m_D.Stator': 'LHM70-3s-2p-S', '2_1.0m_D.OC V': 151, '2_1.0m_D.R V': 76,
         '2_1.0m_E.Stator': 'LHM70-6s-1p-D', '2_1.0m_E.OC V': 160, '2_1.0m_E.R V': 80,
         '2_1.0m_F.Stator': 'LHM70-6s-1p-S', '2_1.0m_F.OC V': 301, '2_1.0m_F.R V': 150, })
    LHdata.update(
        {'2_1.1m_l/s': 15, '2_1.1m_Watts': 79, '2_1.1m_Efficiency': 49, '2_1.1m_RPM': 1261, '2_1.1m_R.RPM': 2370,
         '2_1.1m_W.RPM': 0, '2_1.1m_DT': 0.15, '2_1.1m_DT W': 5, '2_1.1m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.1m_A.OC V': 57, '2_1.1m_A.R V': 28, '2_1.1m_B.Stator': 'LHM70-3s-2p-D', '2_1.1m_B.OC V': 85,
         '2_1.1m_B.R V': 43, '2_1.1m_C.Stator': 'LHM70-2s-3p-S', '2_1.1m_C.OC V': 104, '2_1.1m_C.R V': 52,
         '2_1.1m_D.Stator': 'LHM70-3s-2p-S', '2_1.1m_D.OC V': 159, '2_1.1m_D.R V': 79,
         '2_1.1m_E.Stator': 'LHM70-6s-1p-D', '2_1.1m_E.OC V': 168, '2_1.1m_E.R V': 84,
         '2_1.1m_F.Stator': 'LHM70-6s-1p-S', '2_1.1m_F.OC V': 315, '2_1.1m_F.R V': 158, })
    LHdata.update(
        {'2_1.2m_l/s': 15, '2_1.2m_Watts': 90, '2_1.2m_Efficiency': 49, '2_1.2m_RPM': 1317, '2_1.2m_R.RPM': 2476,
         '2_1.2m_W.RPM': 0, '2_1.2m_DT': 0.15, '2_1.2m_DT W': 6, '2_1.2m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.2m_A.OC V': 59, '2_1.2m_A.R V': 30, '2_1.2m_B.Stator': 'LHM70-3s-2p-D', '2_1.2m_B.OC V': 89,
         '2_1.2m_B.R V': 45, '2_1.2m_C.Stator': 'LHM70-2s-3p-S', '2_1.2m_C.OC V': 109, '2_1.2m_C.R V': 54,
         '2_1.2m_D.Stator': 'LHM70-3s-2p-S', '2_1.2m_D.OC V': 166, '2_1.2m_D.R V': 83,
         '2_1.2m_E.Stator': 'LHM70-6s-1p-D', '2_1.2m_E.OC V': 176, '2_1.2m_E.R V': 88,
         '2_1.2m_F.Stator': 'LHM70-6s-1p-S', '2_1.2m_F.OC V': 329, '2_1.2m_F.R V': 165, })
    LHdata.update(
        {'2_1.3m_l/s': 16, '2_1.3m_Watts': 101, '2_1.3m_Efficiency': 49, '2_1.3m_RPM': 1371, '2_1.3m_R.RPM': 2577,
         '2_1.3m_W.RPM': 0, '2_1.3m_DT': 0.15, '2_1.3m_DT W': 7, '2_1.3m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.3m_A.OC V': 62, '2_1.3m_A.R V': 31, '2_1.3m_B.Stator': 'LHM70-3s-2p-D', '2_1.3m_B.OC V': 93,
         '2_1.3m_B.R V': 46, '2_1.3m_C.Stator': 'LHM70-2s-3p-S', '2_1.3m_C.OC V': 113, '2_1.3m_C.R V': 57,
         '2_1.3m_D.Stator': 'LHM70-3s-2p-S', '2_1.3m_D.OC V': 173, '2_1.3m_D.R V': 86,
         '2_1.3m_E.Stator': 'LHM70-6s-1p-D', '2_1.3m_E.OC V': 183, '2_1.3m_E.R V': 91,
         '2_1.3m_F.Stator': 'LHM70-6s-1p-S', '2_1.3m_F.OC V': 343, '2_1.3m_F.R V': 171, })
    LHdata.update(
        {'2_1.4m_l/s': 17, '2_1.4m_Watts': 114, '2_1.4m_Efficiency': 49, '2_1.4m_RPM': 1422, '2_1.4m_R.RPM': 2674,
         '2_1.4m_W.RPM': 0, '2_1.4m_DT': 0.15, '2_1.4m_DT W': 8, '2_1.4m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.4m_A.OC V': 64, '2_1.4m_A.R V': 32, '2_1.4m_B.Stator': 'LHM70-3s-2p-D', '2_1.4m_B.OC V': 96,
         '2_1.4m_B.R V': 48, '2_1.4m_C.Stator': 'LHM70-2s-3p-S', '2_1.4m_C.OC V': 118, '2_1.4m_C.R V': 59,
         '2_1.4m_D.Stator': 'LHM70-3s-2p-S', '2_1.4m_D.OC V': 179, '2_1.4m_D.R V': 90,
         '2_1.4m_E.Stator': 'LHM70-6s-1p-D', '2_1.4m_E.OC V': 190, '2_1.4m_E.R V': 95,
         '2_1.4m_F.Stator': 'LHM70-6s-1p-S', '2_1.4m_F.OC V': 356, '2_1.4m_F.R V': 178, })
    LHdata.update(
        {'2_1.5m_l/s': 17, '2_1.5m_Watts': 126, '2_1.5m_Efficiency': 50, '2_1.5m_RPM': 1472, '2_1.5m_R.RPM': 2768,
         '2_1.5m_W.RPM': 0, '2_1.5m_DT': 0.15, '2_1.5m_DT W': 8, '2_1.5m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.5m_A.OC V': 66, '2_1.5m_A.R V': 33, '2_1.5m_B.Stator': 'LHM70-3s-2p-D', '2_1.5m_B.OC V': 100,
         '2_1.5m_B.R V': 50, '2_1.5m_C.Stator': 'LHM70-2s-3p-S', '2_1.5m_C.OC V': 122, '2_1.5m_C.R V': 61,
         '2_1.5m_D.Stator': 'LHM70-3s-2p-S', '2_1.5m_D.OC V': 185, '2_1.5m_D.R V': 93,
         '2_1.5m_E.Stator': 'LHM70-6s-1p-D', '2_1.5m_E.OC V': 197, '2_1.5m_E.R V': 98,
         '2_1.5m_F.Stator': 'LHM70-6s-1p-S', '2_1.5m_F.OC V': 368, '2_1.5m_F.R V': 184, })
    LHdata.update(
        {'2_1.6m_l/s': 18, '2_1.6m_Watts': 139, '2_1.6m_Efficiency': 50, '2_1.6m_RPM': 1521, '2_1.6m_R.RPM': 2859,
         '2_1.6m_W.RPM': 0, '2_1.6m_DT': 0.15, '2_1.6m_DT W': 9, '2_1.6m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.6m_A.OC V': 69, '2_1.6m_A.R V': 34, '2_1.6m_B.Stator': 'LHM70-3s-2p-D', '2_1.6m_B.OC V': 103,
         '2_1.6m_B.R V': 51, '2_1.6m_C.Stator': 'LHM70-2s-3p-S', '2_1.6m_C.OC V': 126, '2_1.6m_C.R V': 63,
         '2_1.6m_D.Stator': 'LHM70-3s-2p-S', '2_1.6m_D.OC V': 192, '2_1.6m_D.R V': 96,
         '2_1.6m_E.Stator': 'LHM70-6s-1p-D', '2_1.6m_E.OC V': 203, '2_1.6m_E.R V': 101,
         '2_1.6m_F.Stator': 'LHM70-6s-1p-S', '2_1.6m_F.OC V': 380, '2_1.6m_F.R V': 190, })
    LHdata.update(
        {'2_1.7m_l/s': 18, '2_1.7m_Watts': 153, '2_1.7m_Efficiency': 50, '2_1.7m_RPM': 1567, '2_1.7m_R.RPM': 2947,
         '2_1.7m_W.RPM': 0, '2_1.7m_DT': 0.15, '2_1.7m_DT W': 10, '2_1.7m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.7m_A.OC V': 71, '2_1.7m_A.R V': 35, '2_1.7m_B.Stator': 'LHM70-3s-2p-D', '2_1.7m_B.OC V': 106,
         '2_1.7m_B.R V': 53, '2_1.7m_C.Stator': 'LHM70-2s-3p-S', '2_1.7m_C.OC V': 130, '2_1.7m_C.R V': 65,
         '2_1.7m_D.Stator': 'LHM70-3s-2p-S', '2_1.7m_D.OC V': 197, '2_1.7m_D.R V': 99,
         '2_1.7m_E.Stator': 'LHM70-6s-1p-D', '2_1.7m_E.OC V': 209, '2_1.7m_E.R V': 105,
         '2_1.7m_F.Stator': 'LHM70-6s-1p-S', '2_1.7m_F.OC V': 392, '2_1.7m_F.R V': 196, })
    LHdata.update(
        {'2_1.8m_l/s': 19, '2_1.8m_Watts': 167, '2_1.8m_Efficiency': 50, '2_1.8m_RPM': 1613, '2_1.8m_R.RPM': 3032,
         '2_1.8m_W.RPM': 0, '2_1.8m_DT': 0.15, '2_1.8m_DT W': 11, '2_1.8m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.8m_A.OC V': 73, '2_1.8m_A.R V': 36, '2_1.8m_B.Stator': 'LHM70-3s-2p-D', '2_1.8m_B.OC V': 109,
         '2_1.8m_B.R V': 55, '2_1.8m_C.Stator': 'LHM70-2s-3p-S', '2_1.8m_C.OC V': 133, '2_1.8m_C.R V': 67,
         '2_1.8m_D.Stator': 'LHM70-3s-2p-S', '2_1.8m_D.OC V': 203, '2_1.8m_D.R V': 102,
         '2_1.8m_E.Stator': 'LHM70-6s-1p-D', '2_1.8m_E.OC V': 215, '2_1.8m_E.R V': 108,
         '2_1.8m_F.Stator': 'LHM70-6s-1p-S', '2_1.8m_F.OC V': 403, '2_1.8m_F.R V': 202, })
    LHdata.update(
        {'2_1.9m_l/s': 19, '2_1.9m_Watts': 181, '2_1.9m_Efficiency': 50, '2_1.9m_RPM': 1657, '2_1.9m_R.RPM': 3115,
         '2_1.9m_W.RPM': 0, '2_1.9m_DT': 0.15, '2_1.9m_DT W': 12, '2_1.9m_A.Stator': 'LHM70-2s-3p-D',
         '2_1.9m_A.OC V': 75, '2_1.9m_A.R V': 37, '2_1.9m_B.Stator': 'LHM70-3s-2p-D', '2_1.9m_B.OC V': 112,
         '2_1.9m_B.R V': 56, '2_1.9m_C.Stator': 'LHM70-2s-3p-S', '2_1.9m_C.OC V': 137, '2_1.9m_C.R V': 69,
         '2_1.9m_D.Stator': 'LHM70-3s-2p-S', '2_1.9m_D.OC V': 209, '2_1.9m_D.R V': 104,
         '2_1.9m_E.Stator': 'LHM70-6s-1p-D', '2_1.9m_E.OC V': 221, '2_1.9m_E.R V': 111,
         '2_1.9m_F.Stator': 'LHM70-6s-1p-S', '2_1.9m_F.OC V': 414, '2_1.9m_F.R V': 207, })
    LHdata.update(
        {'2_2.0m_l/s': 20, '2_2.0m_Watts': 196, '2_2.0m_Efficiency': 50, '2_2.0m_RPM': 1700, '2_2.0m_R.RPM': 3196,
         '2_2.0m_W.RPM': 0, '2_2.0m_DT': 0.15, '2_2.0m_DT W': 13, '2_2.0m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.0m_A.OC V': 77, '2_2.0m_A.R V': 38, '2_2.0m_B.Stator': 'LHM70-3s-2p-D', '2_2.0m_B.OC V': 115,
         '2_2.0m_B.R V': 58, '2_2.0m_C.Stator': 'LHM70-2s-3p-S', '2_2.0m_C.OC V': 141, '2_2.0m_C.R V': 70,
         '2_2.0m_D.Stator': 'LHM70-3s-2p-S', '2_2.0m_D.OC V': 214, '2_2.0m_D.R V': 107,
         '2_2.0m_E.Stator': 'LHM70-6s-1p-D', '2_2.0m_E.OC V': 227, '2_2.0m_E.R V': 113,
         '2_2.0m_F.Stator': 'LHM70-6s-1p-S', '2_2.0m_F.OC V': 425, '2_2.0m_F.R V': 213, })
    LHdata.update(
        {'2_2.1m_l/s': 20, '2_2.1m_Watts': 212, '2_2.1m_Efficiency': 50, '2_2.1m_RPM': 1742, '2_2.1m_R.RPM': 3275,
         '2_2.1m_W.RPM': 0, '2_2.1m_DT': 0.15, '2_2.1m_DT W': 14, '2_2.1m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.1m_A.OC V': 79, '2_2.1m_A.R V': 39, '2_2.1m_B.Stator': 'LHM70-3s-2p-D', '2_2.1m_B.OC V': 118,
         '2_2.1m_B.R V': 59, '2_2.1m_C.Stator': 'LHM70-2s-3p-S', '2_2.1m_C.OC V': 144, '2_2.1m_C.R V': 72,
         '2_2.1m_D.Stator': 'LHM70-3s-2p-S', '2_2.1m_D.OC V': 219, '2_2.1m_D.R V': 110,
         '2_2.1m_E.Stator': 'LHM70-6s-1p-D', '2_2.1m_E.OC V': 233, '2_2.1m_E.R V': 116,
         '2_2.1m_F.Stator': 'LHM70-6s-1p-S', '2_2.1m_F.OC V': 436, '2_2.1m_F.R V': 218, })
    LHdata.update(
        {'2_2.2m_l/s': 21, '2_2.2m_Watts': 227, '2_2.2m_Efficiency': 50, '2_2.2m_RPM': 1783, '2_2.2m_R.RPM': 3352,
         '2_2.2m_W.RPM': 0, '2_2.2m_DT': 0.15, '2_2.2m_DT W': 15, '2_2.2m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.2m_A.OC V': 80, '2_2.2m_A.R V': 40, '2_2.2m_B.Stator': 'LHM70-3s-2p-D', '2_2.2m_B.OC V': 121,
         '2_2.2m_B.R V': 60, '2_2.2m_C.Stator': 'LHM70-2s-3p-S', '2_2.2m_C.OC V': 147, '2_2.2m_C.R V': 74,
         '2_2.2m_D.Stator': 'LHM70-3s-2p-S', '2_2.2m_D.OC V': 225, '2_2.2m_D.R V': 112,
         '2_2.2m_E.Stator': 'LHM70-6s-1p-D', '2_2.2m_E.OC V': 238, '2_2.2m_E.R V': 119,
         '2_2.2m_F.Stator': 'LHM70-6s-1p-S', '2_2.2m_F.OC V': 446, '2_2.2m_F.R V': 223, })
    LHdata.update(
        {'2_2.3m_l/s': 21, '2_2.3m_Watts': 243, '2_2.3m_Efficiency': 50, '2_2.3m_RPM': 1823, '2_2.3m_R.RPM': 3427,
         '2_2.3m_W.RPM': 0, '2_2.3m_DT': 0.15, '2_2.3m_DT W': 16, '2_2.3m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.3m_A.OC V': 82, '2_2.3m_A.R V': 41, '2_2.3m_B.Stator': 'LHM70-3s-2p-D', '2_2.3m_B.OC V': 123,
         '2_2.3m_B.R V': 62, '2_2.3m_C.Stator': 'LHM70-2s-3p-S', '2_2.3m_C.OC V': 151, '2_2.3m_C.R V': 75,
         '2_2.3m_D.Stator': 'LHM70-3s-2p-S', '2_2.3m_D.OC V': 230, '2_2.3m_D.R V': 115,
         '2_2.3m_E.Stator': 'LHM70-6s-1p-D', '2_2.3m_E.OC V': 243, '2_2.3m_E.R V': 122,
         '2_2.3m_F.Stator': 'LHM70-6s-1p-S', '2_2.3m_F.OC V': 456, '2_2.3m_F.R V': 228, })
    LHdata.update(
        {'2_2.4m_l/s': 22, '2_2.4m_Watts': 260, '2_2.4m_Efficiency': 50, '2_2.4m_RPM': 1862, '2_2.4m_R.RPM': 3501,
         '2_2.4m_W.RPM': 0, '2_2.4m_DT': 0.15, '2_2.4m_DT W': 17, '2_2.4m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.4m_A.OC V': 84, '2_2.4m_A.R V': 42, '2_2.4m_B.Stator': 'LHM70-3s-2p-D', '2_2.4m_B.OC V': 126,
         '2_2.4m_B.R V': 63, '2_2.4m_C.Stator': 'LHM70-2s-3p-S', '2_2.4m_C.OC V': 154, '2_2.4m_C.R V': 77,
         '2_2.4m_D.Stator': 'LHM70-3s-2p-S', '2_2.4m_D.OC V': 235, '2_2.4m_D.R V': 117,
         '2_2.4m_E.Stator': 'LHM70-6s-1p-D', '2_2.4m_E.OC V': 249, '2_2.4m_E.R V': 124,
         '2_2.4m_F.Stator': 'LHM70-6s-1p-S', '2_2.4m_F.OC V': 466, '2_2.4m_F.R V': 233, })
    LHdata.update(
        {'2_2.5m_l/s': 22, '2_2.5m_Watts': 277, '2_2.5m_Efficiency': 51, '2_2.5m_RPM': 1901, '2_2.5m_R.RPM': 3573,
         '2_2.5m_W.RPM': 0, '2_2.5m_DT': 0.15, '2_2.5m_DT W': 18, '2_2.5m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.5m_A.OC V': 86, '2_2.5m_A.R V': 43, '2_2.5m_B.Stator': 'LHM70-3s-2p-D', '2_2.5m_B.OC V': 129,
         '2_2.5m_B.R V': 64, '2_2.5m_C.Stator': 'LHM70-2s-3p-S', '2_2.5m_C.OC V': 157, '2_2.5m_C.R V': 79,
         '2_2.5m_D.Stator': 'LHM70-3s-2p-S', '2_2.5m_D.OC V': 239, '2_2.5m_D.R V': 120,
         '2_2.5m_E.Stator': 'LHM70-6s-1p-D', '2_2.5m_E.OC V': 254, '2_2.5m_E.R V': 127,
         '2_2.5m_F.Stator': 'LHM70-6s-1p-S', '2_2.5m_F.OC V': 475, '2_2.5m_F.R V': 238, })
    LHdata.update(
        {'2_2.6m_l/s': 23, '2_2.6m_Watts': 294, '2_2.6m_Efficiency': 51, '2_2.6m_RPM': 1938, '2_2.6m_R.RPM': 3644,
         '2_2.6m_W.RPM': 0, '2_2.6m_DT': 0.15, '2_2.6m_DT W': 19, '2_2.6m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.6m_A.OC V': 87, '2_2.6m_A.R V': 44, '2_2.6m_B.Stator': 'LHM70-3s-2p-D', '2_2.6m_B.OC V': 131,
         '2_2.6m_B.R V': 66, '2_2.6m_C.Stator': 'LHM70-2s-3p-S', '2_2.6m_C.OC V': 160, '2_2.6m_C.R V': 80,
         '2_2.6m_D.Stator': 'LHM70-3s-2p-S', '2_2.6m_D.OC V': 244, '2_2.6m_D.R V': 122,
         '2_2.6m_E.Stator': 'LHM70-6s-1p-D', '2_2.6m_E.OC V': 259, '2_2.6m_E.R V': 129,
         '2_2.6m_F.Stator': 'LHM70-6s-1p-S', '2_2.6m_F.OC V': 485, '2_2.6m_F.R V': 242, })
    LHdata.update(
        {'2_2.7m_l/s': 23, '2_2.7m_Watts': 312, '2_2.7m_Efficiency': 51, '2_2.7m_RPM': 1975, '2_2.7m_R.RPM': 3713,
         '2_2.7m_W.RPM': 0, '2_2.7m_DT': 0.15, '2_2.7m_DT W': 20, '2_2.7m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.7m_A.OC V': 89, '2_2.7m_A.R V': 45, '2_2.7m_B.Stator': 'LHM70-3s-2p-D', '2_2.7m_B.OC V': 134,
         '2_2.7m_B.R V': 67, '2_2.7m_C.Stator': 'LHM70-2s-3p-S', '2_2.7m_C.OC V': 163, '2_2.7m_C.R V': 82,
         '2_2.7m_D.Stator': 'LHM70-3s-2p-S', '2_2.7m_D.OC V': 249, '2_2.7m_D.R V': 124,
         '2_2.7m_E.Stator': 'LHM70-6s-1p-D', '2_2.7m_E.OC V': 264, '2_2.7m_E.R V': 132,
         '2_2.7m_F.Stator': 'LHM70-6s-1p-S', '2_2.7m_F.OC V': 494, '2_2.7m_F.R V': 247, })
    LHdata.update(
        {'2_2.8m_l/s': 24, '2_2.8m_Watts': 330, '2_2.8m_Efficiency': 51, '2_2.8m_RPM': 2011, '2_2.8m_R.RPM': 3782,
         '2_2.8m_W.RPM': 0, '2_2.8m_DT': 0.15, '2_2.8m_DT W': 21, '2_2.8m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.8m_A.OC V': 91, '2_2.8m_A.R V': 45, '2_2.8m_B.Stator': 'LHM70-3s-2p-D', '2_2.8m_B.OC V': 136,
         '2_2.8m_B.R V': 68, '2_2.8m_C.Stator': 'LHM70-2s-3p-S', '2_2.8m_C.OC V': 166, '2_2.8m_C.R V': 83,
         '2_2.8m_D.Stator': 'LHM70-3s-2p-S', '2_2.8m_D.OC V': 253, '2_2.8m_D.R V': 127,
         '2_2.8m_E.Stator': 'LHM70-6s-1p-D', '2_2.8m_E.OC V': 268, '2_2.8m_E.R V': 134,
         '2_2.8m_F.Stator': 'LHM70-6s-1p-S', '2_2.8m_F.OC V': 503, '2_2.8m_F.R V': 251, })
    LHdata.update(
        {'2_2.9m_l/s': 24, '2_2.9m_Watts': 349, '2_2.9m_Efficiency': 51, '2_2.9m_RPM': 2047, '2_2.9m_R.RPM': 3848,
         '2_2.9m_W.RPM': 0, '2_2.9m_DT': 0.15, '2_2.9m_DT W': 22, '2_2.9m_A.Stator': 'LHM70-2s-3p-D',
         '2_2.9m_A.OC V': 92, '2_2.9m_A.R V': 46, '2_2.9m_B.Stator': 'LHM70-3s-2p-D', '2_2.9m_B.OC V': 139,
         '2_2.9m_B.R V': 69, '2_2.9m_C.Stator': 'LHM70-2s-3p-S', '2_2.9m_C.OC V': 169, '2_2.9m_C.R V': 85,
         '2_2.9m_D.Stator': 'LHM70-3s-2p-S', '2_2.9m_D.OC V': 258, '2_2.9m_D.R V': 129,
         '2_2.9m_E.Stator': 'LHM70-6s-1p-D', '2_2.9m_E.OC V': 273, '2_2.9m_E.R V': 137,
         '2_2.9m_F.Stator': 'LHM70-6s-1p-S', '2_2.9m_F.OC V': 512, '2_2.9m_F.R V': 256, })
    LHdata.update(
        {'2_3.0m_l/s': 24, '2_3.0m_Watts': 368, '2_3.0m_Efficiency': 51, '2_3.0m_RPM': 2082, '2_3.0m_R.RPM': 3914,
         '2_3.0m_W.RPM': 0, '2_3.0m_DT': 0.15, '2_3.0m_DT W': 24, '2_3.0m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.0m_A.OC V': 94, '2_3.0m_A.R V': 47, '2_3.0m_B.Stator': 'LHM70-3s-2p-D', '2_3.0m_B.OC V': 141,
         '2_3.0m_B.R V': 70, '2_3.0m_C.Stator': 'LHM70-2s-3p-S', '2_3.0m_C.OC V': 172, '2_3.0m_C.R V': 86,
         '2_3.0m_D.Stator': 'LHM70-3s-2p-S', '2_3.0m_D.OC V': 262, '2_3.0m_D.R V': 131,
         '2_3.0m_E.Stator': 'LHM70-6s-1p-D', '2_3.0m_E.OC V': 278, '2_3.0m_E.R V': 139,
         '2_3.0m_F.Stator': 'LHM70-6s-1p-S', '2_3.0m_F.OC V': 521, '2_3.0m_F.R V': 260, })
    LHdata.update(
        {'2_3.1m_l/s': 25, '2_3.1m_Watts': 387, '2_3.1m_Efficiency': 51, '2_3.1m_RPM': 2116, '2_3.1m_R.RPM': 3979,
         '2_3.1m_W.RPM': 0, '2_3.1m_DT': 0.15, '2_3.1m_DT W': 25, '2_3.1m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.1m_A.OC V': 95, '2_3.1m_A.R V': 48, '2_3.1m_B.Stator': 'LHM70-3s-2p-D', '2_3.1m_B.OC V': 143,
         '2_3.1m_B.R V': 72, '2_3.1m_C.Stator': 'LHM70-2s-3p-S', '2_3.1m_C.OC V': 175, '2_3.1m_C.R V': 88,
         '2_3.1m_D.Stator': 'LHM70-3s-2p-S', '2_3.1m_D.OC V': 267, '2_3.1m_D.R V': 133,
         '2_3.1m_E.Stator': 'LHM70-6s-1p-D', '2_3.1m_E.OC V': 283, '2_3.1m_E.R V': 141,
         '2_3.1m_F.Stator': 'LHM70-6s-1p-S', '2_3.1m_F.OC V': 529, '2_3.1m_F.R V': 265, })
    LHdata.update(
        {'2_3.2m_l/s': 25, '2_3.2m_Watts': 406, '2_3.2m_Efficiency': 51, '2_3.2m_RPM': 2150, '2_3.2m_R.RPM': 4043,
         '2_3.2m_W.RPM': 0, '2_3.2m_DT': 0.15, '2_3.2m_DT W': 26, '2_3.2m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.2m_A.OC V': 97, '2_3.2m_A.R V': 49, '2_3.2m_B.Stator': 'LHM70-3s-2p-D', '2_3.2m_B.OC V': 146,
         '2_3.2m_B.R V': 73, '2_3.2m_C.Stator': 'LHM70-2s-3p-S', '2_3.2m_C.OC V': 178, '2_3.2m_C.R V': 89,
         '2_3.2m_D.Stator': 'LHM70-3s-2p-S', '2_3.2m_D.OC V': 271, '2_3.2m_D.R V': 135,
         '2_3.2m_E.Stator': 'LHM70-6s-1p-D', '2_3.2m_E.OC V': 287, '2_3.2m_E.R V': 144,
         '2_3.2m_F.Stator': 'LHM70-6s-1p-S', '2_3.2m_F.OC V': 538, '2_3.2m_F.R V': 269, })
    LHdata.update(
        {'2_3.3m_l/s': 26, '2_3.3m_Watts': 425, '2_3.3m_Efficiency': 51, '2_3.3m_RPM': 2184, '2_3.3m_R.RPM': 4105,
         '2_3.3m_W.RPM': 0, '2_3.3m_DT': 0.15, '2_3.3m_DT W': 27, '2_3.3m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.3m_A.OC V': 99, '2_3.3m_A.R V': 49, '2_3.3m_B.Stator': 'LHM70-3s-2p-D', '2_3.3m_B.OC V': 148,
         '2_3.3m_B.R V': 74, '2_3.3m_C.Stator': 'LHM70-2s-3p-S', '2_3.3m_C.OC V': 181, '2_3.3m_C.R V': 90,
         '2_3.3m_D.Stator': 'LHM70-3s-2p-S', '2_3.3m_D.OC V': 275, '2_3.3m_D.R V': 138,
         '2_3.3m_E.Stator': 'LHM70-6s-1p-D', '2_3.3m_E.OC V': 291, '2_3.3m_E.R V': 146,
         '2_3.3m_F.Stator': 'LHM70-6s-1p-S', '2_3.3m_F.OC V': 546, '2_3.3m_F.R V': 273, })
    LHdata.update(
        {'2_3.4m_l/s': 26, '2_3.4m_Watts': 445, '2_3.4m_Efficiency': 51, '2_3.4m_RPM': 2217, '2_3.4m_R.RPM': 4167,
         '2_3.4m_W.RPM': 0, '2_3.4m_DT': 0.15, '2_3.4m_DT W': 28, '2_3.4m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.4m_A.OC V': 100, '2_3.4m_A.R V': 50, '2_3.4m_B.Stator': 'LHM70-3s-2p-D', '2_3.4m_B.OC V': 150,
         '2_3.4m_B.R V': 75, '2_3.4m_C.Stator': 'LHM70-2s-3p-S', '2_3.4m_C.OC V': 183, '2_3.4m_C.R V': 92,
         '2_3.4m_D.Stator': 'LHM70-3s-2p-S', '2_3.4m_D.OC V': 279, '2_3.4m_D.R V': 140,
         '2_3.4m_E.Stator': 'LHM70-6s-1p-D', '2_3.4m_E.OC V': 296, '2_3.4m_E.R V': 148,
         '2_3.4m_F.Stator': 'LHM70-6s-1p-S', '2_3.4m_F.OC V': 554, '2_3.4m_F.R V': 277, })
    LHdata.update(
        {'2_3.5m_l/s': 26, '2_3.5m_Watts': 466, '2_3.5m_Efficiency': 51, '2_3.5m_RPM': 2249, '2_3.5m_R.RPM': 4228,
         '2_3.5m_W.RPM': 0, '2_3.5m_DT': 0.15, '2_3.5m_DT W': 30, '2_3.5m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.5m_A.OC V': 101, '2_3.5m_A.R V': 51, '2_3.5m_B.Stator': 'LHM70-3s-2p-D', '2_3.5m_B.OC V': 152,
         '2_3.5m_B.R V': 76, '2_3.5m_C.Stator': 'LHM70-2s-3p-S', '2_3.5m_C.OC V': 186, '2_3.5m_C.R V': 93,
         '2_3.5m_D.Stator': 'LHM70-3s-2p-S', '2_3.5m_D.OC V': 283, '2_3.5m_D.R V': 142,
         '2_3.5m_E.Stator': 'LHM70-6s-1p-D', '2_3.5m_E.OC V': 300, '2_3.5m_E.R V': 150,
         '2_3.5m_F.Stator': 'LHM70-6s-1p-S', '2_3.5m_F.OC V': 562, '2_3.5m_F.R V': 281, })
    LHdata.update(
        {'2_3.6m_l/s': 27, '2_3.6m_Watts': 486, '2_3.6m_Efficiency': 51, '2_3.6m_RPM': 2281, '2_3.6m_R.RPM': 4288,
         '2_3.6m_W.RPM': 0, '2_3.6m_DT': 0.15, '2_3.6m_DT W': 31, '2_3.6m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.6m_A.OC V': 103, '2_3.6m_A.R V': 51, '2_3.6m_B.Stator': 'LHM70-3s-2p-D', '2_3.6m_B.OC V': 154,
         '2_3.6m_B.R V': 77, '2_3.6m_C.Stator': 'LHM70-2s-3p-S', '2_3.6m_C.OC V': 189, '2_3.6m_C.R V': 94,
         '2_3.6m_D.Stator': 'LHM70-3s-2p-S', '2_3.6m_D.OC V': 287, '2_3.6m_D.R V': 144,
         '2_3.6m_E.Stator': 'LHM70-6s-1p-D', '2_3.6m_E.OC V': 304, '2_3.6m_E.R V': 152,
         '2_3.6m_F.Stator': 'LHM70-6s-1p-S', '2_3.6m_F.OC V': 570, '2_3.6m_F.R V': 285, })
    LHdata.update(
        {'2_3.7m_l/s': 27, '2_3.7m_Watts': 507, '2_3.7m_Efficiency': 51, '2_3.7m_RPM': 2312, '2_3.7m_R.RPM': 4347,
         '2_3.7m_W.RPM': 0, '2_3.7m_DT': 0.15, '2_3.7m_DT W': 32, '2_3.7m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.7m_A.OC V': 104, '2_3.7m_A.R V': 52, '2_3.7m_B.Stator': 'LHM70-3s-2p-D', '2_3.7m_B.OC V': 156,
         '2_3.7m_B.R V': 78, '2_3.7m_C.Stator': 'LHM70-2s-3p-S', '2_3.7m_C.OC V': 191, '2_3.7m_C.R V': 96,
         '2_3.7m_D.Stator': 'LHM70-3s-2p-S', '2_3.7m_D.OC V': 291, '2_3.7m_D.R V': 146,
         '2_3.7m_E.Stator': 'LHM70-6s-1p-D', '2_3.7m_E.OC V': 309, '2_3.7m_E.R V': 154,
         '2_3.7m_F.Stator': 'LHM70-6s-1p-S', '2_3.7m_F.OC V': 578, '2_3.7m_F.R V': 289, })
    LHdata.update(
        {'2_3.8m_l/s': 28, '2_3.8m_Watts': 528, '2_3.8m_Efficiency': 51, '2_3.8m_RPM': 2343, '2_3.8m_R.RPM': 4405,
         '2_3.8m_W.RPM': 0, '2_3.8m_DT': 0.15, '2_3.8m_DT W': 34, '2_3.8m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.8m_A.OC V': 106, '2_3.8m_A.R V': 53, '2_3.8m_B.Stator': 'LHM70-3s-2p-D', '2_3.8m_B.OC V': 159,
         '2_3.8m_B.R V': 79, '2_3.8m_C.Stator': 'LHM70-2s-3p-S', '2_3.8m_C.OC V': 194, '2_3.8m_C.R V': 97,
         '2_3.8m_D.Stator': 'LHM70-3s-2p-S', '2_3.8m_D.OC V': 295, '2_3.8m_D.R V': 148,
         '2_3.8m_E.Stator': 'LHM70-6s-1p-D', '2_3.8m_E.OC V': 313, '2_3.8m_E.R V': 156,
         '2_3.8m_F.Stator': 'LHM70-6s-1p-S', '2_3.8m_F.OC V': 586, '2_3.8m_F.R V': 293, })
    LHdata.update(
        {'2_3.9m_l/s': 28, '2_3.9m_Watts': 550, '2_3.9m_Efficiency': 51, '2_3.9m_RPM': 2374, '2_3.9m_R.RPM': 4463,
         '2_3.9m_W.RPM': 0, '2_3.9m_DT': 0.15, '2_3.9m_DT W': 35, '2_3.9m_A.Stator': 'LHM70-2s-3p-D',
         '2_3.9m_A.OC V': 107, '2_3.9m_A.R V': 54, '2_3.9m_B.Stator': 'LHM70-3s-2p-D', '2_3.9m_B.OC V': 161,
         '2_3.9m_B.R V': 80, '2_3.9m_C.Stator': 'LHM70-2s-3p-S', '2_3.9m_C.OC V': 196, '2_3.9m_C.R V': 98,
         '2_3.9m_D.Stator': 'LHM70-3s-2p-S', '2_3.9m_D.OC V': 299, '2_3.9m_D.R V': 150,
         '2_3.9m_E.Stator': 'LHM70-6s-1p-D', '2_3.9m_E.OC V': 317, '2_3.9m_E.R V': 158,
         '2_3.9m_F.Stator': 'LHM70-6s-1p-S', '2_3.9m_F.OC V': 594, '2_3.9m_F.R V': 297, })
    LHdata.update(
        {'2_4.0m_l/s': 28, '2_4.0m_Watts': 572, '2_4.0m_Efficiency': 51, '2_4.0m_RPM': 2404, '2_4.0m_R.RPM': 4520,
         '2_4.0m_W.RPM': 0, '2_4.0m_DT': 0.15, '2_4.0m_DT W': 36, '2_4.0m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.0m_A.OC V': 108, '2_4.0m_A.R V': 54, '2_4.0m_B.Stator': 'LHM70-3s-2p-D', '2_4.0m_B.OC V': 163,
         '2_4.0m_B.R V': 81, '2_4.0m_C.Stator': 'LHM70-2s-3p-S', '2_4.0m_C.OC V': 199, '2_4.0m_C.R V': 99,
         '2_4.0m_D.Stator': 'LHM70-3s-2p-S', '2_4.0m_D.OC V': 303, '2_4.0m_D.R V': 151,
         '2_4.0m_E.Stator': 'LHM70-6s-1p-D', '2_4.0m_E.OC V': 321, '2_4.0m_E.R V': 160,
         '2_4.0m_F.Stator': 'LHM70-6s-1p-S', '2_4.0m_F.OC V': 601, '2_4.0m_F.R V': 301, })
    LHdata.update(
        {'2_4.1m_l/s': 29, '2_4.1m_Watts': 594, '2_4.1m_Efficiency': 52, '2_4.1m_RPM': 2434, '2_4.1m_R.RPM': 4576,
         '2_4.1m_W.RPM': 0, '2_4.1m_DT': 0.15, '2_4.1m_DT W': 38, '2_4.1m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.1m_A.OC V': 110, '2_4.1m_A.R V': 55, '2_4.1m_B.Stator': 'LHM70-3s-2p-D', '2_4.1m_B.OC V': 165,
         '2_4.1m_B.R V': 82, '2_4.1m_C.Stator': 'LHM70-2s-3p-S', '2_4.1m_C.OC V': 201, '2_4.1m_C.R V': 101,
         '2_4.1m_D.Stator': 'LHM70-3s-2p-S', '2_4.1m_D.OC V': 307, '2_4.1m_D.R V': 153,
         '2_4.1m_E.Stator': 'LHM70-6s-1p-D', '2_4.1m_E.OC V': 325, '2_4.1m_E.R V': 162,
         '2_4.1m_F.Stator': 'LHM70-6s-1p-S', '2_4.1m_F.OC V': 609, '2_4.1m_F.R V': 304, })
    LHdata.update(
        {'2_4.2m_l/s': 29, '2_4.2m_Watts': 616, '2_4.2m_Efficiency': 52, '2_4.2m_RPM': 2464, '2_4.2m_R.RPM': 4631,
         '2_4.2m_W.RPM': 0, '2_4.2m_DT': 0.15, '2_4.2m_DT W': 39, '2_4.2m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.2m_A.OC V': 111, '2_4.2m_A.R V': 56, '2_4.2m_B.Stator': 'LHM70-3s-2p-D', '2_4.2m_B.OC V': 167,
         '2_4.2m_B.R V': 83, '2_4.2m_C.Stator': 'LHM70-2s-3p-S', '2_4.2m_C.OC V': 204, '2_4.2m_C.R V': 102,
         '2_4.2m_D.Stator': 'LHM70-3s-2p-S', '2_4.2m_D.OC V': 310, '2_4.2m_D.R V': 155,
         '2_4.2m_E.Stator': 'LHM70-6s-1p-D', '2_4.2m_E.OC V': 329, '2_4.2m_E.R V': 164,
         '2_4.2m_F.Stator': 'LHM70-6s-1p-S', '2_4.2m_F.OC V': 616, '2_4.2m_F.R V': 308, })
    LHdata.update(
        {'2_4.3m_l/s': 29, '2_4.3m_Watts': 639, '2_4.3m_Efficiency': 52, '2_4.3m_RPM': 2493, '2_4.3m_R.RPM': 4686,
         '2_4.3m_W.RPM': 0, '2_4.3m_DT': 0.15, '2_4.3m_DT W': 40, '2_4.3m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.3m_A.OC V': 112, '2_4.3m_A.R V': 56, '2_4.3m_B.Stator': 'LHM70-3s-2p-D', '2_4.3m_B.OC V': 169,
         '2_4.3m_B.R V': 84, '2_4.3m_C.Stator': 'LHM70-2s-3p-S', '2_4.3m_C.OC V': 206, '2_4.3m_C.R V': 103,
         '2_4.3m_D.Stator': 'LHM70-3s-2p-S', '2_4.3m_D.OC V': 314, '2_4.3m_D.R V': 157,
         '2_4.3m_E.Stator': 'LHM70-6s-1p-D', '2_4.3m_E.OC V': 333, '2_4.3m_E.R V': 166,
         '2_4.3m_F.Stator': 'LHM70-6s-1p-S', '2_4.3m_F.OC V': 623, '2_4.3m_F.R V': 312, })
    LHdata.update(
        {'2_4.4m_l/s': 30, '2_4.4m_Watts': 662, '2_4.4m_Efficiency': 52, '2_4.4m_RPM': 2522, '2_4.4m_R.RPM': 4740,
         '2_4.4m_W.RPM': 0, '2_4.4m_DT': 0.15, '2_4.4m_DT W': 42, '2_4.4m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.4m_A.OC V': 114, '2_4.4m_A.R V': 57, '2_4.4m_B.Stator': 'LHM70-3s-2p-D', '2_4.4m_B.OC V': 171,
         '2_4.4m_B.R V': 85, '2_4.4m_C.Stator': 'LHM70-2s-3p-S', '2_4.4m_C.OC V': 209, '2_4.4m_C.R V': 104,
         '2_4.4m_D.Stator': 'LHM70-3s-2p-S', '2_4.4m_D.OC V': 318, '2_4.4m_D.R V': 159,
         '2_4.4m_E.Stator': 'LHM70-6s-1p-D', '2_4.4m_E.OC V': 337, '2_4.4m_E.R V': 168,
         '2_4.4m_F.Stator': 'LHM70-6s-1p-S', '2_4.4m_F.OC V': 630, '2_4.4m_F.R V': 315, })
    LHdata.update(
        {'2_4.5m_l/s': 30, '2_4.5m_Watts': 685, '2_4.5m_Efficiency': 52, '2_4.5m_RPM': 2550, '2_4.5m_R.RPM': 4794,
         '2_4.5m_W.RPM': 0, '2_4.5m_DT': 0.15, '2_4.5m_DT W': 43, '2_4.5m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.5m_A.OC V': 115, '2_4.5m_A.R V': 58, '2_4.5m_B.Stator': 'LHM70-3s-2p-D', '2_4.5m_B.OC V': 173,
         '2_4.5m_B.R V': 86, '2_4.5m_C.Stator': 'LHM70-2s-3p-S', '2_4.5m_C.OC V': 211, '2_4.5m_C.R V': 105,
         '2_4.5m_D.Stator': 'LHM70-3s-2p-S', '2_4.5m_D.OC V': 321, '2_4.5m_D.R V': 161,
         '2_4.5m_E.Stator': 'LHM70-6s-1p-D', '2_4.5m_E.OC V': 340, '2_4.5m_E.R V': 170,
         '2_4.5m_F.Stator': 'LHM70-6s-1p-S', '2_4.5m_F.OC V': 638, '2_4.5m_F.R V': 319, })
    LHdata.update(
        {'2_4.6m_l/s': 30, '2_4.6m_Watts': 709, '2_4.6m_Efficiency': 52, '2_4.6m_RPM': 2578, '2_4.6m_R.RPM': 4847,
         '2_4.6m_W.RPM': 0, '2_4.6m_DT': 0.15, '2_4.6m_DT W': 45, '2_4.6m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.6m_A.OC V': 116, '2_4.6m_A.R V': 58, '2_4.6m_B.Stator': 'LHM70-3s-2p-D', '2_4.6m_B.OC V': 174,
         '2_4.6m_B.R V': 87, '2_4.6m_C.Stator': 'LHM70-2s-3p-S', '2_4.6m_C.OC V': 213, '2_4.6m_C.R V': 107,
         '2_4.6m_D.Stator': 'LHM70-3s-2p-S', '2_4.6m_D.OC V': 325, '2_4.6m_D.R V': 162,
         '2_4.6m_E.Stator': 'LHM70-6s-1p-D', '2_4.6m_E.OC V': 344, '2_4.6m_E.R V': 172,
         '2_4.6m_F.Stator': 'LHM70-6s-1p-S', '2_4.6m_F.OC V': 645, '2_4.6m_F.R V': 322, })
    LHdata.update(
        {'2_4.7m_l/s': 31, '2_4.7m_Watts': 733, '2_4.7m_Efficiency': 52, '2_4.7m_RPM': 2606, '2_4.7m_R.RPM': 4899,
         '2_4.7m_W.RPM': 0, '2_4.7m_DT': 0.15, '2_4.7m_DT W': 46, '2_4.7m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.7m_A.OC V': 118, '2_4.7m_A.R V': 59, '2_4.7m_B.Stator': 'LHM70-3s-2p-D', '2_4.7m_B.OC V': 176,
         '2_4.7m_B.R V': 88, '2_4.7m_C.Stator': 'LHM70-2s-3p-S', '2_4.7m_C.OC V': 216, '2_4.7m_C.R V': 108,
         '2_4.7m_D.Stator': 'LHM70-3s-2p-S', '2_4.7m_D.OC V': 328, '2_4.7m_D.R V': 164,
         '2_4.7m_E.Stator': 'LHM70-6s-1p-D', '2_4.7m_E.OC V': 348, '2_4.7m_E.R V': 174,
         '2_4.7m_F.Stator': 'LHM70-6s-1p-S', '2_4.7m_F.OC V': 652, '2_4.7m_F.R V': 326, })
    LHdata.update(
        {'2_4.8m_l/s': 31, '2_4.8m_Watts': 757, '2_4.8m_Efficiency': 52, '2_4.8m_RPM': 2634, '2_4.8m_R.RPM': 4951,
         '2_4.8m_W.RPM': 0, '2_4.8m_DT': 0.15, '2_4.8m_DT W': 48, '2_4.8m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.8m_A.OC V': 119, '2_4.8m_A.R V': 59, '2_4.8m_B.Stator': 'LHM70-3s-2p-D', '2_4.8m_B.OC V': 178,
         '2_4.8m_B.R V': 89, '2_4.8m_C.Stator': 'LHM70-2s-3p-S', '2_4.8m_C.OC V': 218, '2_4.8m_C.R V': 109,
         '2_4.8m_D.Stator': 'LHM70-3s-2p-S', '2_4.8m_D.OC V': 332, '2_4.8m_D.R V': 166,
         '2_4.8m_E.Stator': 'LHM70-6s-1p-D', '2_4.8m_E.OC V': 352, '2_4.8m_E.R V': 176,
         '2_4.8m_F.Stator': 'LHM70-6s-1p-S', '2_4.8m_F.OC V': 659, '2_4.8m_F.R V': 329, })
    LHdata.update(
        {'2_4.9m_l/s': 31, '2_4.9m_Watts': 782, '2_4.9m_Efficiency': 52, '2_4.9m_RPM': 2661, '2_4.9m_R.RPM': 5003,
         '2_4.9m_W.RPM': 0, '2_4.9m_DT': 0.15, '2_4.9m_DT W': 49, '2_4.9m_A.Stator': 'LHM70-2s-3p-D',
         '2_4.9m_A.OC V': 120, '2_4.9m_A.R V': 60, '2_4.9m_B.Stator': 'LHM70-3s-2p-D', '2_4.9m_B.OC V': 180,
         '2_4.9m_B.R V': 90, '2_4.9m_C.Stator': 'LHM70-2s-3p-S', '2_4.9m_C.OC V': 220, '2_4.9m_C.R V': 110,
         '2_4.9m_D.Stator': 'LHM70-3s-2p-S', '2_4.9m_D.OC V': 335, '2_4.9m_D.R V': 168,
         '2_4.9m_E.Stator': 'LHM70-6s-1p-D', '2_4.9m_E.OC V': 355, '2_4.9m_E.R V': 178,
         '2_4.9m_F.Stator': 'LHM70-6s-1p-S', '2_4.9m_F.OC V': 665, '2_4.9m_F.R V': 333, })
    LHdata.update(
        {'2_5.0m_l/s': 32, '2_5.0m_Watts': 807, '2_5.0m_Efficiency': 52, '2_5.0m_RPM': 2688, '2_5.0m_R.RPM': 5053,
         '2_5.0m_W.RPM': 0, '2_5.0m_DT': 0.15, '2_5.0m_DT W': 51, '2_5.0m_A.Stator': 'LHM70-2s-3p-D',
         '2_5.0m_A.OC V': 121, '2_5.0m_A.R V': 61, '2_5.0m_B.Stator': 'LHM70-3s-2p-D', '2_5.0m_B.OC V': 182,
         '2_5.0m_B.R V': 91, '2_5.0m_C.Stator': 'LHM70-2s-3p-S', '2_5.0m_C.OC V': 222, '2_5.0m_C.R V': 111,
         '2_5.0m_D.Stator': 'LHM70-3s-2p-S', '2_5.0m_D.OC V': 339, '2_5.0m_D.R V': 169,
         '2_5.0m_E.Stator': 'LHM70-6s-1p-D', '2_5.0m_E.OC V': 359, '2_5.0m_E.R V': 179,
         '2_5.0m_F.Stator': 'LHM70-6s-1p-S', '2_5.0m_F.OC V': 672, '2_5.0m_F.R V': 336, })
...
def computeSDtype(ElectOP_W, ShaftRPM, NLshaftRPM, vmax, vmin):
    ...
    site.debug += 'Are in compute SD type with' + str(ElectOP_W) + "," + str(ShaftRPM) + "," + str(
        NLshaftRPM) + "," + str(vmax) + "," + str(vmin)
    ShaftRPM *= (
        0.1081 * site.LH_head + 0.7021)  # Correction to Michaels rmp figures to get voltages right  * (0.1081 * site.LH_head + 0.7021)
    ...
    for SDchk in site.SD_types:  # Iterates over { '100--S','100--D','80--S','80--D','60--S','60--D','60dc--S','60dc--D','60dc-HPS','60dc-HP-D'.......}
        ...
        for packers in range(0, 10):  # Itterate through all the packer sizes
            ...
            MaxWmake = (VIpacked(packers)) * (VIpacked(packers)) \
                       * (site.SD_Max_e_mW4rpm4setA[SDchk] * ShaftRPM ** 2.0 \
                          ...
                          + site.SD_Max_e_mW4rpm4setC[
                              SDchk])  # MaxWuse = electrical watts out at MPP of this SD in mW per finger set
            ...
            for fsets in range(int(minfsets),
                ...
                for series in range(1,
                    ...
                    VoutNoLoad = VIpacked(packers) * series * site.SD_mV4rpm4set[
                        SDchk] * ShaftRPM / 1000  # Note that the table is in mV!
                    VoutNoLoadmax = VIpacked(packers) * series * site.SD_mV4rpm4set[
                        SDchk] * NLshaftRPM / 1000  # Note that the table is in mV!
                    ...
                    site.SDsearch = site.SDsearch + (SDchk + '        ')[:11] + (str(series) + 'S' + str(
                        parallel) + 'P  ' + '   ')[:8] \
                                    + (str(round(VrRequired, 3)) + 'Vr         ')[:9] \
                                    + Vo_diag[len(Vo_diag) - 16:] + Vl_diag[len(Vl_diag) - 16:] \
                                    + '  ' + (str(round(VoutNoLoad, 1)) + ' SD nl V          ')[:15] \
                                    + ' at ' + str(round(WnormPERfset * 100, 1)) + '% of MPP  ' + str(
                        VoutNoLoadmax) + 'V no load free spinning' + siteGUI.GUI_diag_cr
                    ###########################################
                    ###########################################
                    ###########################################
                    # print (SDchk + '        ')[:11] \
                    ...
                    if TargetLdV > vmin and VoutNoLoadmax < vmax:  # abs(TargetLdV / site.cable_Vgen - 1.0 ) < ( site.SDcloseness / 100.0 ) :        # Have found a SD type that is close enough. Create the SD code!
                        ...
                        BuildChoice = BuildChoice * PackersPref(packers) * loadingPref(WnormPERfset) * VPref(vmax,
                                                                                                             VoutNoLoadmax)
                        ...
                        SD_size_listC[SD_size_list_ptr] = str(
                            int(round(TargetLdV, 0)))  # Operating voltage this SD at this shaft speed
                        SD_size_listD[SD_size_list_ptr] = str(
                            int(round(VoutNoLoadmax, 0)))  # Open circuit voltage at runaway rpm
                        SD_size_listE[
                        ...
                        SD_size_listG[SD_size_list_ptr] = str(
                            int(round(WnormPERfset * 100, 0)))  # % loading of this stator
    ...
    if siteGUI.GUI_LHtype == 'LH/LH Pro':
        ...
        siteGUI.GUI_design_notes_SD = siteGUI.GUI_design_notes_SD + str(
            SD_size_list_ptr) + ' options found.' + siteGUI.GUIcr
        siteGUI.GUI_design_notes_SD = siteGUI.GUI_design_notes_SD + 'Operating at ' + str(
            round(ElectOP_W / ShaftRPM, 3)) + ' W/rpm' + siteGUI.GUIcr + siteGUI.GUIcr
        ...
        for SDoption in ['A.', 'B.', 'C.', 'D.', 'E.', 'F.']:
            ...
            thisVmax = str(
                int(round(site.LHdata[(site.indexbase + SDoption + 'OC V')], 0)))  # Open circuit voltage at runaway rpm
            thisVopr = str(int(round(site.LHdata[(site.indexbase + SDoption + 'R V')],
                                     0)))  # Operating voltage this SD at this shaft speed
...
def LH_Pipe():  # Determine capacity of a Manning pipe at 81.96 & 100% full by height
    ...
    site.pipe_capacity = FigureManningPipe(
        0.8196)  # 81.96% full by height is same capacity as 100% full but less than at 93.82% which is in surging range.
    if (site.pipe_capacity < site.avail_lps):
        site.usable_water = site.pipe_capacity
...
def eff2use(
        frac):  # What turbine efficiency to use as eff drops at lower than ideal water flow? Lookup dictionary site.eff[ ] and straight line interpolate
...
def Fetch_LH_4_next_Vmin(
        Vmax_min):  # Search SD gens to find the next up Vmax option after the current site.SDchoice selected SD
...
def CalcCable():  # Work out cable performance. Select cable size if needed.
    ...
    if (site.LH_V_NL == 0 or site.LH_V_Opr < site.Load_Vmin - 1):
        ...
        site.cableR = float(
            site.material[site.cable_material] * float(1e6) / site.cable_size * site.cable_len * float(2))
        ...
        if int(site.cableLock) == int(
                0):  # If no user lock on cable size And not initial data then go pick a cable size for the target cable loss     and siteGUI.GUI_initial_data == 0
            # print 'calc cable from scratch'
            site.Load_pwr = site.cable_eff_target * site.LH_pwr_tot  # Power to load
            site.cable_Vdrop = site.LH_V_Opr * (
                1 - site.cable_eff_target)  # total volts lost accross cable in both directions
            site.cable_voltage = site.LH_V_Opr - site.cable_Vdrop
        ...
        if site.cable_size > previous_cablesize:
            ...
            if int(site.cableLock) == int(1):  # Test if cable size locked cause then is a user size being adjusted.
                site.alarms.append(
                    53)  # Note to alm reporting section that users cable size was increased to handle current
        ...
        if site.cable_voltage < site.Load_Vmin:  # If true voltage drop is too much so must increase cable size and tell user
            ...
            site.cable_size = round(site.material[site.cable_material] * 1e6 / site.cableR_req, 1)  # Sqr mm needed
            site.alarms.append(
                55)  # Note to alm reporting section that cable size was increased to cover match Vmin of inverter
...
def computeALL():  # Do the calculation of inputs to create outputs following all design limits
    ...
    if site.LH_V_Opr < site.Load_Vmin:  # Check if under Vmin of inverter, Over Vmin LHh, and that do not have a Vmax problem     and 1-(50 in site.alarms)
        ...
        if 1 - (50 in site.alarms):
            if site.LH_V_Opr > 75:
                site.alarms.append(
                    51)  # Advise user of under voltage problem and to use a lower Vmin or increase Vmax to ...?????
            else:
        ...
        if site.LH_V_cap > 0:  # Check to avoid divide by zero
            if site.LH_V_Opr / site.LH_V_cap and site.Num_LH > 1:  # Check to see if are at maximum lps per turbine and >1 of LH cause less LH turbines may be enough
                site.alarms.append(
                    60)  # Fewer turbines may do the trick to increase V operate as are at less than max lps per turbine
    ...
    if (site.cable_A > 0 and site.cable_amp_spec / site.cable_A < 1.5):
        site.alarms.append(
            56)  # Cable size within 50% of likely current rating. Please check with your cable supplier for suitability. Amps temp rise etc

    #################################################################################################################################################################################
    # Check cable oversize expense
    if site.LH_V_Opr > 0:
        if 1 - (
                                    52 in site.alarms or 53 in site.alarms or 54 in site.alarms or 55 in site.alarms or 56 in site.alarms) and site.cable_voltage / site.LH_V_Opr > 0.98 and site.cable_len > 30:
            site.alarms.append(
                57)  # Cable size within 50% of likely current rating. Please check with your cable supplier for suitability. Amps temp rise etc
...
def cable_amps_rate(smm):  # Convert cable square mm into a nominal amps rating
    ...
    amp_limit2 = float(smm * 10 * pow(smm, 0.74)) / (
                                                        site.material[site.cable_material] / site.material[
                                                            'Copper']) ** 0.5
...
def reportAll():  # Report all results to user gui. This is the only place where gui values get updated for the user to see
    ...
    if 15 in site.alarms:
        ...
        if (siteGUI.GUI_meas_sys == 'Imperial'):
            text2 = str(int(round(FigureManningPipe(0.9382) * site.convert['gpm-lps'],
                                  3 - int(log10(site.pipe_capacity * site.convert['gpm-lps']))))) + ' gpm'
    ...
    if 21 in site.alarms: siteGUI.GUI_design_notes_hydro = siteGUI.GUI_design_notes_hydro + \
                                                           ...
                                                           'and provide more power. ' + str(
        int(site.maxWnumLH)) + ' LH hydro units is best.' + siteGUI.GUIcr + siteGUI.GUIcr
    #
    if 22 in site.alarms: siteGUI.GUI_design_notes_hydro = siteGUI.GUI_design_notes_hydro + \
                                                           ...
                                                           'and provide more power. ' + str(
        int(site.Num_LH)) + ' LH hydro units is best.' + siteGUI.GUIcr + siteGUI.GUIcr
    #
    ...
    if 51 in site.alarms:  # site.cable_voltage < site.Load_Vmin AND site.cable_voltage > 75 (LH hydro is 75Vout min)
        siteGUI.GUI_design_notes_elec = siteGUI.GUI_design_notes_elec + \
                                        ...
                                        'Use an inverter with a Vmin input less than ' + str(
            int(site.LH_V_Opr_guide)) + 'V. '
        if site.LH_Vmax_guide > 0:
            siteGUI.GUI_design_notes_elec = siteGUI.GUI_design_notes_elec + \
                                            'An inverter with a higher Vmax of over ' + str(
                int(site.LH_Vmax_guide)) + ' may help.' + siteGUI.GUIcr + siteGUI.GUIcr
        else:
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                     It took " + str(
        site.pipe_iterations) + " iterations to solve pipe flow rate" + siteGUI.GUI_diag_cr
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "       Turbine operating rpm " + str(
        site.LH_rpm_Opr) + "rpm" + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                 runaway_rpm " + str(
        site.LH_rpm_NL) + "rpm" + siteGUI.GUI_diag_cr
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "         pipe_flow_roughness " + str(
        site.pipe_flow_roughness) + siteGUI.GUI_diag_cr
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "      siteGUI.GUI_LockNumLH " + str(
        siteGUI.GUI_LockNumLH) + siteGUI.GUI_diag_cr
...
def put_Pipe_Cap():
    ...
    if (siteGUI.GUI_meas_sys == 'Imperial'):
        siteGUI.GUI_pipe_capacity = str(int(round(site.pipe_capacity * site.convert['gpm-lps'], 3 - int(
            log10(site.pipe_capacity * site.convert['gpm-lps']))))) + ' gpm'
...
def reportGUI():  # Fill up diagnostics "siteGUI.GUI_diag" with info
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                      GUI_LHtype " + str(
        siteGUI.GUI_LHtype) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                   GUI_avail_lps " + str(
        siteGUI.GUI_avail_lps) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                  GUI_actual_lps " + str(
        siteGUI.GUI_actual_lps) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                   GUI_pipe_head " + str(
        siteGUI.GUI_pipe_head) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                    GUI_pipe_len " + str(
        siteGUI.GUI_pipe_len) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "               GUI_pipe_capacity " + str(
        siteGUI.GUI_pipe_capacity) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                    GUI_pipe_dia " + str(
        siteGUI.GUI_pipe_dia) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                      GUI_Num_LH " + str(
        siteGUI.GUI_Num_LH) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                   GUI_LockNumLH " + str(
        siteGUI.GUI_LockNumLH) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "               GUI_pipe_capacity " + str(
        siteGUI.GUI_pipe_capacity) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                     GUI_rpm_Opr " + str(
        siteGUI.GUI_LH_rpm_Opr) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                GUI_LH_watts_Opr " + str(
        siteGUI.GUI_LH_watts_Opr) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                  GUI_LH_pwr_tot " + str(
        siteGUI.GUI_LH_pwr_tot) + siteGUI.GUI_diag_cr
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                   GUI_Load_Vmax " + str(
        siteGUI.GUI_Load_Vmax) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                     GUI_Aload_V " + str(
        siteGUI.GUI_Aload_V) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                      GUI_load_W " + str(
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                     GUI_cable_A " + str(
        siteGUI.GUI_cable_A) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "            GUI_actual_cable_eff " + str(
        siteGUI.GUI_actual_cable_eff) + siteGUI.GUI_diag_cr
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                    GUI_LH_V_Opr " + str(
        siteGUI.GUI_LH_V_Opr) + siteGUI.GUI_diag_cr
    ...
    siteGUI.GUI_diag = siteGUI.GUI_diag + "                    GUI_revision " + str(
        siteGUI.GUI_revision) + siteGUI.GUI_diag_cr + siteGUI.GUI_diag_cr
...
def process_here(*args):
    ...
    if (siteGUI.GUI_process_option == 'basicdata'):
        ...
        if (siteGUI.GUI_initial_data == 1):
            ...
            if ((siteGUI.GUI_initial_data == 1) and (site.lps != 0) and (site.LH_head != 0) and (
                        site.Load_Vmax >= 50)):  # Test if have enough preliminary data
