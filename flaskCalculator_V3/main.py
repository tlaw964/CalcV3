...
def PS_fetchGUI_data(*args):
    ...
    if ((request.form.get('InitialData', None)) is not None): PS_siteGUI.GUI_initial_data = int(
        request.form.get('InitialData', None))
    if ((request.form.get('Units', None)) is not None): PS_siteGUI.GUI_meas_sys = str(request.form.get('Units', None))
    if ((request.form.get('processOption', None)) is not None): PS_siteGUI.GUI_process_option = str(
        request.form.get('processOption', None))
    if ((request.form.get('Flow', None)) is not None): PS_siteGUI.GUI_avail_Wflow = str(request.form.get('Flow', None))
    if ((request.form.get('PipeHead', None)) is not None): PS_siteGUI.GUI_penstock_head = str(
        request.form.get('PipeHead', None))
    if ((request.form.get('PipeLenth', None)) is not None): PS_siteGUI.GUI_penstock_len = str(
        request.form.get('PipeLenth', None))
    if ((request.form.get('PipeEfficiency', None)) is not None): PS_siteGUI.GUI_penstock_eff_target = str(
        request.form.get('PipeEfficiency', None))
    if ((request.form.get('PipeDiameter', None)) is not None): PS_siteGUI.GUI_penstock_dia = str(
        request.form.get('PipeDiameter', None))
    if ((request.form.get('LockPipeDiameter', None)) is not None): PS_siteGUI.GUI_PenSLkd = int(
        request.form.get('LockPipeDiameter', None))
    if ((request.form.get('Powerspouts', None)) is not None): PS_siteGUI.GUI_Num_PS = int(
        request.form.get('Powerspouts', None))
    if ((request.form.get('LockPowerspouts', None)) is not None): PS_siteGUI.GUI_Num_PS_Lkd = int(
        request.form.get('LockPowerspouts', None))
    if ((request.form.get('Nozzles', None)) is not None): PS_siteGUI.GUI_turbine_nozzles = int(
        request.form.get('Nozzles', None))
    if ((request.form.get('CableEfficiency', None)) is not None): PS_siteGUI.GUI_cable_eff_target = str(
        request.form.get('CableEfficiency', None))
    if ((request.form.get('CableLength', None)) is not None): PS_siteGUI.GUI_cable_len = str(
        request.form.get('CableLength', None))
    if ((request.form.get('LoadVoltage', None)) is not None): PS_siteGUI.GUI_Dload_V = str(
        request.form.get('LoadVoltage', None))
    if ((request.form.get('LockCableSize', None)) is not None): PS_siteGUI.GUI_LockCable = int(
        request.form.get('LockCableSize', None))
    if ((request.form.get('CableMaterial', None)) is not None): PS_siteGUI.GUI_cable_material = str(
        request.form.get('CableMaterial', None))
    if ((request.form.get('CableSize', None)) is not None): PS_siteGUI.GUI_cable_size = str(
        request.form.get('CableSize', None))
    if ((request.form.get('CableAWG', None)) is not None): PS_siteGUI.GUI_cable_AWG = str(
        request.form.get('CableAWG', None))


def LH_fetchGUI_data(*args):
    # this function Fetches the data from the form ignoring any values of type None i.e havent been entered yet
    LH_siteGUI.GUI_LHtype = str('LH/LH Pro')
    if ((request.form.get('InitialData', None)) is not None): LH_siteGUI.GUI_initial_data = int(
        request.form.get('InitialData', None))
    if ((request.form.get('processOption', None)) is not None): LH_siteGUI.GUI_process_option = str(
        request.form.get('processOption', None))
    if ((request.form.get('MeasSys', None)) is not None): LH_siteGUI.GUI_meas_sys = str(
        request.form.get('MeasSys', None))
    if ((request.form.get('AvailLPS', None)) is not None): LH_siteGUI.GUI_avail_lps = str(
        request.form.get('AvailLPS', None))
    if ((request.form.get('PipeHead', None)) is not None): LH_siteGUI.GUI_pipe_head = str(
        request.form.get('PipeHead', None))
    if ((request.form.get('PipeLen', None)) is not None): LH_siteGUI.GUI_pipe_len = str(
        request.form.get('PipeLen', None))
    if ((request.form.get('PipeFlume', None)) is not None): LH_siteGUI.GUI_PipeFlume = str(
        request.form.get('PipeFlume', None))
    if ((request.form.get('PipeMat', None)) is not None): LH_siteGUI.GUI_pipe_mat = str(
        request.form.get('PipeMat', None))
    if ((request.form.get('PipeDia', None)) is not None): LH_siteGUI.GUI_pipe_dia = str(
        request.form.get('PipeDia', None))
    if ((request.form.get('PipeHeight', None)) is not None): LH_siteGUI.GUI_pipe_height = str(
        request.form.get('PipeHeight', None))
    ...
    if ((request.form.get('LockNumLH', None)) is not None): LH_siteGUI.GUI_LockNumLH = int(
        request.form.get('LockNumLH', None))
    if ((request.form.get('CableEffTarget', None)) is not None): LH_siteGUI.GUI_cable_eff_target = str(
        request.form.get('CableEffTarget', None))
    if ((request.form.get('CableLen', None)) is not None): LH_siteGUI.GUI_cable_len = str(
        request.form.get('CableLen', None))
    if ((request.form.get('LoadVmax', None)) is not None): LH_siteGUI.GUI_Load_Vmax = str(
        request.form.get('LoadVmax', None))
    # else:siteGUI.GUI_Load_Vmax =str('150 V')
    if ((request.form.get('LoadVmin', None)) is not None): LH_siteGUI.GUI_Load_Vmin = str(
        request.form.get('LoadVmin', None))
    if ((request.form.get('LockCable', None)) is not None): LH_siteGUI.GUI_LockCable = int(
        request.form.get('LockCable', None))
    if ((request.form.get('CableMaterial', None)) is not None): LH_siteGUI.GUI_cable_material = str(
        request.form.get('CableMaterial', None))
    if ((request.form.get('CableSize', None)) is not None): LH_siteGUI.GUI_cable_size = str(
        request.form.get('CableSize', None))
    if ((request.form.get('CableAWG', None)) is not None): LH_siteGUI.GUI_cable_AWG = str(
        request.form.get('CableAWG', None))


def PHP_fetchGUI_data(*args):
    # this function Fetches the data from the form ignoring any values of type None i.e havent been entered yet
    if ((request.form.get('processOption', None)) is not None): PHP_siteGUI.GUI_process_option = str(
        request.form.get('processOption'))
    if ((request.form.get('meas_sys', None)) is not None): PHP_siteGUI.GUI_meas_sys = str(request.form.get('meas_sys'))
    if ((request.form.get('available_input_flow', None)) is not None): PHP_siteGUI.GUI_available_input_flow = str(
        request.form.get('available_input_flow'))
    # if(request.form.get('actual_IP_flow', None)) is not None): PHP_siteGUI.GUI_actual_IP_flow = str(request.form.get('actual_IP_flow'))
    if ((request.form.get('input_head', None)) is not None): PHP_siteGUI.GUI_input_head = str(
        request.form.get('input_head'))
    # if(request.form.get('eff_input_head', None)) is not None): PHP_siteGUI.GUI_eff_input_head = str(request.form.get('eff_input_head'))
    if ((request.form.get('input_eff', None)) is not None): PHP_siteGUI.GUI_input_eff = str(
        request.form.get('input_eff'))
    if ((request.form.get('input_pipe_diam', None)) is not None): PHP_siteGUI.GUI_input_pipe_diam = str(
        request.form.get('input_pipe_diam'))
    if ((request.form.get('input_pipe_len', None)) is not None): PHP_siteGUI.GUI_input_pipe_len = str(
        request.form.get('input_pipe_len'))
    if ((request.form.get('lock_penstock_dia', None)) is not None): PHP_siteGUI.GUI_lock_penstock_dia = int(
        request.form.get('lock_penstock_dia'))
    if ((request.form.get('number_of_spouts', None)) is not None): PHP_siteGUI.GUI_number_of_spouts = str(
        request.form.get('number_of_spouts'))
    if ((request.form.get('number_of_jets', None)) is not None): PHP_siteGUI.GUI_number_of_jets = str(
        request.form.get('number_of_jets'))
    if ((request.form.get('lock_PHPs_jets', None)) is not None): PHP_siteGUI.GUI_lock_PHPs_jets = int(
        request.form.get('lock_PHPs_jets'))
    # if(request.form.get('eff_input_head', None)) is not None): PHP_siteGUI.GUI_eff_input_head = str(request.form.get('eff_input_head'))
    ...
    if ((request.form.get('output_head', None)) is not None): PHP_siteGUI.GUI_output_head = str(
        request.form.get('output_head'))
    if ((request.form.get('output_pipe_len', None)) is not None): PHP_siteGUI.GUI_output_pipe_len = str(
        request.form.get('output_pipe_len'))
    if ((request.form.get('output_eff', None)) is not None): PHP_siteGUI.GUI_output_eff = str(
        request.form.get('output_eff'))
    if ((request.form.get('output_pipe_diam', None)) is not None): PHP_siteGUI.GUI_output_pipe_diam = str(
        request.form.get('output_pipe_diam'))
    if ((request.form.get('lock_OP_pipe_dia', None)) is not None): PHP_siteGUI.GUI_lock_OP_pipe_dia = str(
        request.form.get('lock_OP_pipe_dia'))
    if ((request.form.get('total_OP_flow', None)) is not None): PHP_siteGUI.GUI_total_OP_flow = str(
        request.form.get('total_OP_flow'))
    if ((request.form.get('total_OP_flow_day', None)) is not None): PHP_siteGUI.GUI_total_OP_flow_day = str(
        request.form.get('total_OP_flow_day'))
...
def submitForm():
    ...
    try:  # Try to submit data to spreadsheet if somthing goes wrong let them know
        ...
        creds = ServiceAccountCredentials.from_json_keyfile_name('static/client_secret.json',
                                                                 scope)  # '/home/tlaw964/FlaskCalc/flaskCalculator_V3/static/client_secret.json'
        client = gspread.authorize(creds)  # dgd
