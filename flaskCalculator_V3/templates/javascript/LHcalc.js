...
sendData('firstStart');
        ...
        $("input[name='AvailLPS']").on('keypress paste',function (event) {

            setTimeout(function () { sendData('basicdata', $("input[name='AvailLPS']")); }, 2000);

        });

         $("input[name='LHHead']").on('keypress paste',function (event) {
        ...
        $("input[name='PipeDia']").on('keypress paste',function () {
            setTimeout(function () { sendData('pipe_dia', $("select[name='PipeDia']")); }, 2000);
        });
        $("input[name='PipeHeight']").on('keypress paste',function () {
            setTimeout(function () { sendData('pipe_dia',  $("input[name='PipeHeight']")); }, 2000);
        });
        $("input[name='PipeLen']").on('keypress paste',function () {
        ...
        $("input[name='NumLH']").on('keypress paste',function () {
